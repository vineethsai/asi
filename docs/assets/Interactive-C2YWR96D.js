import{d as V,a as p,j as e,B as v,T as _}from"./index-f2vvIK68.js";import{H as E}from"./Helmet-JGt7dfgc.js";import{C as l,a as c,e as D,h as z}from"./architecturesData-S3e8xhzc.js";import{B as g}from"./badge-B8v9q_Ia.js";import{P as j,C as M}from"./checkbox-D74QO5qI.js";import{T as L,a as q,b as H,c as F}from"./tabs-CZfeF3O_.js";import{A as k,a as w,S as G}from"./alert-Cfsf3N0S.js";import{A as O,a as B,b as W,c as U}from"./accordion-DRQhrrfC.js";import{C as J}from"./circle-check-big-a971CFKf.js";import{T as $}from"./target-z0xDcsKr.js";import{S as Y}from"./shield-Bn0pu4aH.js";import{D as Z}from"./database-CPZh7MAe.js";import{L as K}from"./lock-B0Qs0eMt.js";import{E as Q}from"./eye-CVC0MV5c.js";import{H as X}from"./Header-Bb6PKgD6.js";import{F as ee}from"./Footer-BShOulqq.js";import{Z as te}from"./zap-BjPBPNyv.js";import"./check-CCigx7sx.js";import"./index-DttgYYao.js";import"./index-i6Zu5HQD.js";import"./chevron-down-BewSPha_.js";import"./input-BsxEJ_wZ.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ie=V("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]),ae={blue:{bg:"bg-blue-100 dark:bg-blue-950/30",text:"text-blue-800 dark:text-blue-300",border:"border-blue-200"},green:{bg:"bg-green-100 dark:bg-green-950/30",text:"text-green-800 dark:text-green-300",border:"border-green-200"},purple:{bg:"bg-purple-100 dark:bg-purple-950/30",text:"text-purple-800 dark:text-purple-300",border:"border-purple-200"},orange:{bg:"bg-orange-100 dark:bg-orange-950/30",text:"text-orange-800 dark:text-orange-300",border:"border-orange-200"},red:{bg:"bg-red-100 dark:bg-red-950/30",text:"text-red-800 dark:text-red-300",border:"border-red-200"}},d=[{id:"input-validation",name:"Input Validation & Filtering",description:"Protect against prompt injection and malicious inputs",icon:e.jsx(Y,{className:"h-5 w-5"}),color:"blue",items:[{id:"prompt-injection-defense",title:"Implement Prompt Injection Defense",description:"Deploy comprehensive protection against prompt injection attacks",category:"input-validation",priority:"critical",aisvsReference:"C2.1",implementationGuide:"Set up multi-layered defense including input validation, instruction hierarchy enforcement, and pattern detection for known injection techniques.",codeExample:`
...
if len(flagged_idx) > 0:
    ...
    logger.warning(f"Flagged {len(flagged_idx)} samples for poisoning review")
        `,estimatedTime:"12-20 hours",verificationSteps:["Test with known poisoning examples","Verify detection sensitivity","Check false positive rates","Validate alerting mechanisms"]}]},{id:"access-control",name:"Access Control & Authentication",description:"Secure access to AI systems and data",icon:e.jsx(K,{className:"h-5 w-5"}),color:"purple",items:[{id:"api-authentication",title:"API Authentication & Authorization",description:"Implement robust authentication for all API endpoints",category:"access-control",priority:"critical",aisvsReference:"C3.1",implementationGuide:"Deploy strong authentication mechanisms including API keys, OAuth 2.0, or JWT tokens with proper authorization controls.",codeExample:`
...
// await checkRateLimit(req.userId ?? req.ip, 'ai');
        `,estimatedTime:"2-4 hours",verificationSteps:["Test rate limits are enforced","Verify different limits per endpoint","Check burst handling","Validate legitimate users not blocked"]}]},{id:"monitoring",name:"Monitoring & Logging",description:"Monitor AI system behavior and maintain audit logs",icon:e.jsx(Q,{className:"h-5 w-5"}),color:"orange",items:[{id:"controlled-deployment",title:"Controlled Deployment & Rollback",description:"Implement gradual rollout mechanisms and atomic rollback capabilities for model deployments",category:"monitoring",priority:"critical",aisvsReference:"C3.3",implementationGuide:"Implement gradual rollout mechanisms (canary, blue-green deployments) with automated rollback triggers based on error rates, latency thresholds, or security alerts. Ensure atomic rollback restores complete model state including weights, configurations, and dependencies.",codeExample:`
...
async function recordModelChange(audit: Omit<ModelChangeAuditRecord, 'id' | 'timestamp'>): Promise<void> {
  ...
  logAccessAttempt(record.id, 'write', getCurrentUserId());
        ...
        `,estimatedTime:"4-8 hours",verificationSteps:["Verify all model changes generate audit records","Check audit records include before/after states","Validate prompt templates are version-controlled","Test audit log access controls"]}]}],re=()=>{const[n,h]=p.useState(new Set),[S,N]=p.useState("input-validation"),[x,C]=p.useState(!1);p.useEffect(()=>{const t=localStorage.getItem("ai-security-checklist");t&&h(new Set(JSON.parse(t)))},[]),p.useEffect(()=>{localStorage.setItem("ai-security-checklist",JSON.stringify(Array.from(n)))},[n]);const I=t=>{h(a=>{const i=new Set(a);return i.has(t)?i.delete(t):i.add(t),i})},A=()=>{h(new Set),localStorage.removeItem("ai-security-checklist")},u=d.reduce((t,a)=>t+a.items.length,0),f=n.size,y=u>0?f/u*100:0,b=t=>{const a=d.find(o=>o.id===t);return a?a.items.filter(o=>n.has(o.id)).length/a.items.length*100:0},R=t=>{switch(t){case"critical":return"bg-red-100 text-red-800 dark:bg-red-950/30 dark:text-red-300";case"high":return"bg-orange-100 text-orange-800 dark:bg-orange-950/30 dark:text-orange-300";case"medium":return"bg-yellow-100 text-yellow-800 dark:bg-yellow-950/30 dark:text-yellow-300";case"low":return"bg-green-100 text-green-800 dark:bg-green-950/30 dark:text-green-300";default:return"bg-gray-100 text-gray-800 dark:bg-gray-950/30 dark:text-gray-300"}},r=(()=>{const t=d.flatMap(s=>s.items).filter(s=>s.priority==="critical"),a=d.flatMap(s=>s.items).filter(s=>s.priority==="high"),i=t.filter(s=>n.has(s.id)).length,o=a.filter(s=>n.has(s.id)).length,m=t.length>0?i/t.length*60:60,T=a.length>0?o/a.length*30:30,P=f/u*10;return Math.round(m+T+P)})();return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-4",children:"AI Security Implementation Checklist"}),e.jsx("p",{className:"text-muted-foreground max-w-2xl mx-auto",children:"Follow this comprehensive checklist to implement security controls for your AI system based on OWASP AISVS standards. Track your progress and get implementation guidance."})]}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-4 gap-4",children:[e.jsx(l,{className:"security-card",children:e.jsxs(c,{className:"p-4 text-center",children:[e.jsxs("div",{className:"text-3xl font-bold text-primary mb-1",children:[f,"/",u]}),e.jsx("div",{className:"text-sm text-muted-foreground",children:"Items Complete"})]})}),e.jsx(l,{className:"security-card",children:e.jsxs(c,{className:"p-4 text-center",children:[e.jsxs("div",{className:"text-3xl font-bold text-primary mb-1",children:[Math.round(y),"%"]}),e.jsx("div",{className:"text-sm text-muted-foreground",children:"Progress"})]})}),e.jsx(l,{className:"security-card",children:e.jsxs(c,{className:"p-4 text-center",children:[e.jsxs("div",{className:`text-3xl font-bold mb-1 ${r>=80?"text-green-600":r>=60?"text-yellow-600":"text-red-600"}`,children:[r,"/100"]}),e.jsx("div",{className:"text-sm text-muted-foreground",children:"Security Score"})]})}),e.jsx(l,{className:"security-card",children:e.jsxs(c,{className:"p-4 text-center",children:[e.jsx("div",{className:"text-3xl font-bold text-primary mb-1",children:d.filter(t=>b(t.id)===100).length}),e.jsx("div",{className:"text-sm text-muted-foreground",children:"Categories Done"})]})})]}),e.jsx(l,{className:"bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30",children:e.jsxs(c,{className:"p-6",children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("h3",{className:"text-lg font-semibold",children:"Overall Security Implementation"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(v,{variant:"outline",size:"sm",onClick:()=>C(!x),children:x?"Show All":"Show Completed"}),e.jsxs(v,{variant:"outline",size:"sm",onClick:A,children:[e.jsx(ie,{className:"h-4 w-4 mr-2"}),"Reset"]})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex justify-between text-sm",children:[e.jsx("span",{children:"Progress"}),e.jsxs("span",{children:[Math.round(y),"% complete"]})]}),e.jsx(j,{value:y,className:"h-3"})]}),r<80&&e.jsxs(k,{className:"mt-4 bg-yellow-50 dark:bg-yellow-950/30 border-yellow-200",children:[e.jsx(_,{className:"h-4 w-4"}),e.jsxs(w,{children:[e.jsxs("strong",{children:["Security Score: ",r,"/100"]}),e.jsx("br",{}),r<40&&"Critical security gaps identified. Prioritize implementing critical and high priority items.",r>=40&&r<60&&"Moderate security posture. Focus on completing high priority items.",r>=60&&r<80&&"Good progress! Complete remaining critical items to improve security."]})]}),r>=80&&e.jsxs(k,{className:"mt-4 bg-green-50 dark:bg-green-950/30 border-green-200",children:[e.jsx(J,{className:"h-4 w-4"}),e.jsxs(w,{children:[e.jsxs("strong",{children:["Excellent Security Score: ",r,"/100"]}),e.jsx("br",{}),"Your AI system has strong security controls implemented. Continue monitoring and maintaining these controls."]})]})]})}),e.jsxs(L,{value:S,onValueChange:N,className:"w-full",children:[e.jsx(q,{className:"grid w-full grid-cols-4",children:d.map(t=>e.jsxs(H,{value:t.id,className:"flex items-center gap-2",children:[t.icon,e.jsx("span",{className:"hidden sm:inline",children:t.name.split(" ")[0]}),e.jsxs(g,{variant:"outline",className:"text-xs",children:[Math.round(b(t.id)),"%"]})]},t.id))}),d.map(t=>{var a;return e.jsxs(F,{value:t.id,className:"space-y-4",children:[e.jsxs(l,{className:"security-card",children:[e.jsx(D,{children:e.jsxs(z,{className:"flex items-center gap-3",children:[e.jsx("div",{className:`p-2 rounded-lg ${((a=ae[t.color])==null?void 0:a.bg)??"bg-gray-100 dark:bg-gray-950/30"}`,children:t.icon}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-xl",children:t.name}),e.jsx("p",{className:"text-muted-foreground text-sm font-normal",children:t.description})]})]})}),e.jsxs(c,{children:[e.jsxs("div",{className:"flex items-center justify-between mb-4",children:[e.jsx("span",{className:"text-sm font-medium",children:"Category Progress"}),e.jsxs("span",{className:"text-sm text-muted-foreground",children:[t.items.filter(i=>n.has(i.id)).length,"/",t.items.length," complete"]})]}),e.jsx(j,{value:b(t.id),className:"h-2"})]})]}),e.jsx("div",{className:"space-y-4",children:t.items.filter(i=>!x||n.has(i.id)).map(i=>e.jsx(l,{className:`checklist-item ${n.has(i.id)?"completed":""}`,children:e.jsx(c,{className:"p-0",children:e.jsx(O,{type:"single",collapsible:!0,className:"w-full",children:e.jsxs(B,{value:i.id,className:"border-none",children:[e.jsx(W,{className:"px-6 py-4 hover:no-underline",children:e.jsxs("div",{className:"flex items-start gap-4 w-full",children:[e.jsx(M,{checked:n.has(i.id),onCheckedChange:()=>I(i.id),className:"mt-1"}),e.jsxs("div",{className:"flex-1 text-left",children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("h4",{className:"font-semibold",children:i.title}),e.jsx(g,{className:R(i.priority),children:i.priority}),e.jsx(g,{variant:"outline",className:"text-xs",children:i.aisvsReference})]}),e.jsx("p",{className:"text-sm text-muted-foreground",children:i.description}),e.jsx("div",{className:"flex items-center gap-4 mt-2 text-xs text-muted-foreground",children:e.jsxs("span",{children:["⏱️ ",i.estimatedTime]})})]})]})}),e.jsx(U,{className:"px-6 pb-6",children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium mb-2",children:"Implementation Guide"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:i.implementationGuide})]}),i.codeExample&&e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium mb-2",children:"Code Example"}),e.jsx("pre",{className:"text-xs overflow-auto bg-muted p-4 rounded-lg",children:e.jsx("code",{children:i.codeExample.trim()})})]}),e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium mb-2",children:"Verification Steps"}),e.jsx("ul",{className:"space-y-1",children:i.verificationSteps.map((o,m)=>e.jsxs("li",{className:"flex items-center gap-2 text-sm",children:[e.jsx($,{className:"h-3 w-3 text-muted-foreground"}),o]},m))})]}),i.dependencies&&e.jsxs("div",{children:[e.jsx("h5",{className:"font-medium mb-2",children:"Dependencies"}),e.jsx("div",{className:"flex flex-wrap gap-2",children:i.dependencies.map((o,m)=>e.jsx(g,{variant:"outline",className:"text-xs",children:o},m))})]})]})})]})})})},i.id))})]},t.id)})]})]})};function Ae(){return e.jsxs(e.Fragment,{children:[e.jsxs(E,{children:[e.jsx("title",{children:"Security Implementation Checklist | Agentic Security Hub"}),e.jsx("meta",{name:"description",content:"Step-by-step AI security implementation checklist with progress tracking, code examples, and OWASP AISVS references for securing agentic AI systems."}),e.jsx("meta",{name:"keywords",content:"AI security checklist, AI agent security implementation, secure AI development, OWASP AISVS, agentic systems security, security controls checklist"}),e.jsx("meta",{name:"robots",content:"index, follow"}),e.jsx("link",{rel:"canonical",href:"https://agenticsecurity.info/interactive"}),e.jsx("meta",{property:"og:title",content:"Security Implementation Checklist | Agentic Security Hub"}),e.jsx("meta",{property:"og:description",content:"Step-by-step AI security implementation checklist with progress tracking and code examples."}),e.jsx("meta",{property:"og:type",content:"website"}),e.jsx("meta",{property:"og:url",content:"https://agenticsecurity.info/interactive"}),e.jsx("meta",{name:"twitter:card",content:"summary_large_image"}),e.jsx("meta",{name:"twitter:title",content:"Security Implementation Checklist | Agentic Security Hub"}),e.jsx("meta",{name:"twitter:description",content:"Step-by-step AI security implementation checklist with progress tracking and code examples."})]}),e.jsx(X,{}),e.jsxs("main",{id:"main-content",className:"container mx-auto px-4 py-8 space-y-8",children:[e.jsxs("div",{className:"text-center space-y-4",children:[e.jsxs("div",{className:"inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium",children:[e.jsx(te,{className:"h-4 w-4","aria-hidden":"true"}),"Interactive Security Guidance"]}),e.jsxs("h1",{className:"text-4xl lg:text-5xl font-bold tracking-tight",children:["Security Implementation",e.jsx("span",{className:"block text-primary",children:"Checklist"})]}),e.jsx("p",{className:"text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed",children:"A step-by-step implementation guide with progress tracking, code examples, and AISVS references to help you systematically apply security controls to your agentic AI systems."}),e.jsxs("div",{className:"flex items-center justify-center gap-2 text-sm text-muted-foreground",children:[e.jsx(G,{className:"h-4 w-4","aria-hidden":"true"}),e.jsx("span",{children:"Your progress is saved automatically in your browser."})]})]}),e.jsx(re,{})]}),e.jsx(ee,{})]})}export{Ae as default};
