      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-8">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
            Visualize AI agent architectures and explore the revolutionary NIST AI RMF to AISVS
            mapping with interactive D3.js visualizations
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div>
            <div
              className="relative bg-card/50 backdrop-blur-sm rounded-xl border border-border/50 shadow-lg overflow-hidden"
              style={{
