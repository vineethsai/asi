...
export const threatsData: Record<string, Threat> = {
  t1: {
    ...
    attackVectors: [
      {
        vector: "Data Injection",
        example: "Injecting malicious payloads into session memory",
        severity: "high",
      },
      {
        vector: "Context Manipulation",
        example: "Altering agent's context window to bias outputs",
        severity: "medium",
      },
      {
        vector: "Session Contamination",
        example: "Cross-session poisoning via shared memory",
        severity: "medium",
      },
      {
        vector: "Poisoned RAG sources",
        example: "Supplying tainted data to retrieval-augmented generation",
        severity: "high",
      },
      {
        vector: "Training Data Corruption",
        example: "Systematically poisoning knowledge bases with subtle biases",
        severity: "high",
      },
      {
        vector: "Memory Persistence Attacks",
        example: "Creating malicious memories that persist across sessions",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m1", "m5", "m4", "m11", "m12", "m17"],
    tags: ["memory", "injection", "RAG", "persistence", "knowledge-base"],
    references: [
      {
        title: "OWASP AI Security",
        url: "https://owasp.org/www-project-top-10-for-large-language-models/",
      },
      {
        title: "RAG Poisoning Attack Techniques",
        url: "https://www.promptfoo.dev/blog/rag-poisoning/",
      },
      {
        title: "Data Poisoning in AI Systems",
    ...
    displayOrder: 1,
    asiMapping: ["ASI06"],
    ciscoMapping: ["OB-005", "OB-006", "OB-007"],
  },
  t2: {
    id: "t2",
    code: "T2",
    ...
    affectedComponents: [
      "Tool Integration Layer (KC5.1-KC5.4)",
      "External Environment Interface (KC6.1-KC6.3)",
    ],
    attackVectors: [
      {
        vector: "Prompt Injection for Tool Abuse",
        example: "Manipulating agent to execute unauthorized tool commands",
        severity: "high",
      },
      {
        vector: "Tool Chain Exploitation",
        example: "Chaining multiple tool calls to achieve unauthorized outcomes",
        severity: "high",
      },
      {
        vector: "API Parameter Manipulation",
        example: "Modifying tool parameters to access restricted resources",
        severity: "medium",
      },
      {
        vector: "Tool Authentication Bypass",
        example: "Exploiting tool authentication mechanisms",
        severity: "high",
      },
      {
        vector: "Resource Exhaustion via Tools",
        example: "Using tools to overwhelm external services",
        severity: "medium",
      },
      {
        vector: "Lateral Movement through Tools",
        example: "Using legitimate tools to access unintended systems",
        severity: "high",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m2", "m7", "m12", "m14", "m6", "m10", "m9", "m17", "m18"],
    ...
    references: [
      ...
      {
        title: "Tool Misuse in Agentic Systems",
  ...
  t3: {
    ...
    affectedComponents: [
      "Memory Modules (KC4.1-KC4.6)",
      "Tool Integration Layer (KC5.1-KC5.4)",
      "External Environment Interface (KC6.1-KC6.3)",
    ],
    attackVectors: [
      {
        vector: "Role Inheritance Exploitation",
        example: "Exploiting dynamic role assignments to gain elevated privileges",
        severity: "high",
      },
      {
        vector: "Permission Escalation",
        example: "Agent retains admin permissions beyond intended duration",
        severity: "high",
      },
      {
        vector: "Context Collapse",
        example: "Breaking isolation boundaries between different user contexts",
        severity: "medium",
      },
      {
        vector: "Confused Deputy Attack",
        example: "Tricking privileged agent to perform unauthorized actions",
        severity: "high",
      },
      {
        vector: "Service Account Token Theft",
        example: "Extracting cloud service account tokens from agent environment",
        severity: "high",
      },
      {
        vector: "Cross-Tenant Data Access",
        example: "Accessing data from different organizational tenants",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m7", "m10", "m1", "m2", "m6", "m15", "m14", "m18", "m17"],
    tags: ["privilege", "escalation", "rbac", "isolation", "permissions"],
    references: [
      {
        title: "Privilege Escalation in AI Systems",
        url: "https://www.beyondtrust.com/blog/entry/privilege-escalation-attack-defense-explained",
      },
      {
        title: "OWASP Agent Authorization Controls",
        url: "https://github.com/precize/OWASP-Agentic-AI/blob/main/agent-auth-control-01.md",
      },
    ],
    riskScore: 9,
    impactAnalysis: { confidentiality: true, integrity: true, availability: false },
  ...
  t4: {
    ...
    description:
      "Overwhelming external services through excessive API calls or resource consumption, potentially causing denial of service or excessive costs.",
    impactLevel: "medium",
    componentIds: ["kc6"],
    affectedComponents: ["External Environment Interface (KC6.1-KC6.3)"],
    attackVectors: [
      {
        vector: "API Rate Limit Exhaustion",
        example: "Flooding external APIs with requests to cause service denial",
        severity: "medium",
      },
      {
        vector: "Compute Resource Exhaustion",
        example: "Overwhelming agent processing power with complex tasks",
        severity: "medium",
      },
      {
        vector: "Memory Consumption Attack",
        example: "Causing agent to consume excessive memory resources",
        severity: "medium",
      },
      {
        vector: "Concurrent Task Flooding",
        example: "Triggering multiple resource-intensive operations simultaneously",
        severity: "high",
      },
      {
        vector: "Cost Amplification Attack",
        example: "Exploiting pay-per-use services to generate excessive costs",
        severity: "medium",
      },
      {
        vector: "Feedback Loop Exploitation",
        example: "Creating recursive operations that consume resources",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m9", "m2", "m8", "m14"],
    tags: ["resources", "denial-of-service", "rate-limiting", "costs", "performance"],
    references: [
      {
        title: "Resource Management in AI Agents",
        url: "https://www.xenonstack.com/blog/vulnerabilities-in-ai-agents",
      },
      {
        title: "DoS Prevention in Agentic Systems",
        url: "https://undercodetesting.com/top-10-agentic-ai-threats-a-deep-dive-into-owasps-security-risks/",
      },
    ],
    riskScore: 6,
  ...
  t5: {
    ...
    affectedComponents: [
      "Foundation Model (KC1.1-KC1.3)",
      "Reasoning Engine (KC3.1-KC3.4)",
      "Memory Modules (KC4.1-KC4.6)",
    ],
    attackVectors: [
      {
        vector: "False Information Injection",
        example: "Introducing fabricated facts that propagate through agent reasoning",
        severity: "medium",
      },
      {
        vector: "Memory Contamination",
        example: "Storing hallucinated information in long-term memory",
        severity: "high",
      },
      {
        vector: "Cross-Agent Misinformation",
        example: "Spreading false information between multiple agents",
        severity: "medium",
      },
      {
        vector: "Confidence Amplification",
        example: "Reinforcing false information through repeated exposure",
        severity: "medium",
      },
      {
        vector: "Decision Chain Corruption",
        example: "Contaminating multi-step reasoning processes",
        severity: "high",
      },
      {
        vector: "Source Attribution Errors",
        example: "Misattributing fabricated information to legitimate sources",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m5", "m11", "m1", "m4", "m12", "m16"],
    tags: ["hallucination", "misinformation", "reasoning", "verification", "propagation"],
    references: [
      {
        title: "Cascading Hallucinations in AI",
        url: "https://www.resilientcyber.io/p/agentic-ai-threats-and-mitigations",
      },
      {
        title: "Information Integrity in Agent Systems",
  ...
  t6: {
    ...
    description:
      "Attacks that manipulate the agent's core decision-making to achieve unauthorized goals, breaking control flow, abusing shared context, or interfering with isolated data.",
    impactLevel: "high",
    componentIds: ["kc1", "kc2", "kc3", "kc4", "kc5"],
    affectedComponents: [
      "Foundation Model (KC1.1-KC1.3)",
      "Agent Orchestration (KC2.1-KC2.5)",
      "Reasoning Engine (KC3.1-KC3.4)",
      "Memory Modules (KC4.1-KC4.6)",
      "Tool Integration Layer (KC5.1-KC5.4)",
    ],
    attackVectors: [
      {
        vector: "Goal Substitution",
        example: "Replacing agent's primary objectives with malicious goals",
        severity: "high",
      },
      {
        vector: "Intent Parser Overflow",
        example: "Overwhelming intent extraction with complex nested requests",
        severity: "medium",
      },
      {
        vector: "Semantic Ambiguity Exploitation",
        example: "Crafting instructions with multiple interpretations",
        severity: "high",
      },
      {
        vector: "Priority Inversion",
        example: "Manipulating task priorities to execute unauthorized actions first",
        severity: "medium",
      },
      {
        vector: "Control Flow Hijacking",
        example: "Redirecting agent execution to unintended code paths",
        severity: "high",
      },
      {
        vector: "Context Window Poisoning",
        example: "Injecting malicious context to influence decision-making",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m4", "m5", "m1", "m8", "m11", "m16"],
    tags: ["intent", "goals", "manipulation", "control-flow", "semantic"],
    references: [
      {
        title: "Agent Goal Manipulation",
        url: "https://github.com/precize/OWASP-Agentic-AI/blob/main/agent-goal-instruction-03.md",
      },
      {
        title: "Intent Breaking in AI Agents",
        url: "https://www.humansecurity.com/learn/blog/agentic-ai-security-owasp-threats/",
      },
    ],
    riskScore: 8,
    impactAnalysis: { confidentiality: true, integrity: true, availability: true },
  ...
  t7: {
    ...
    description:
      "Model alignment issues leading to unintended behaviors that impact users, organizations, or broader populations through subtle reasoning or tool usage misalignments.",
    impactLevel: "medium",
    ...
    attackVectors: [
      {
        vector: "Value Misalignment",
        example: "Agent pursuing objectives contrary to organizational values",
        severity: "medium",
      },
      {
        vector: "Ethical Boundary Violations",
        example: "Circumventing ethical guidelines through creative reasoning",
        severity: "high",
      },
      {
        vector: "Unintended Optimization",
        example: "Optimizing for metrics that lead to harmful outcomes",
        severity: "medium",
      },
      {
        vector: "Deceptive Behavior",
        example: "Agent hiding its true intentions while appearing compliant",
        severity: "high",
      },
      {
        vector: "Social Manipulation",
        example: "Exploiting human psychology to achieve goals",
        severity: "medium",
      },
      {
        vector: "Emergent Harmful Behaviors",
        example: "Developing unexpected harmful strategies",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m15", "m5", "m11", "m4", "m12"],
    ...
    references: [
      ...
      {
        title: "Misaligned AI Behavior Detection",
    ...
    icon: "misalign",
    displayOrder: 7,
    asiMapping: ["ASI09", "ASI10"],
    ciscoMapping: ["OB-008", "OB-015"],
  },
  t8: {
    id: "t8",
    code: "T8",
    name: "Repudiation",
    description:
      "Making agent actions difficult to trace through workflow manipulation, obscuring decision trails in reasoning chains, or tampering with evidence in memory.",
    impactLevel: "medium",
    ...
    attackVectors: [
      {
        vector: "Log Tampering",
        example: "Modifying or deleting audit trails of agent actions",
        severity: "medium",
      },
      {
        vector: "Decision Trail Obfuscation",
        example: "Making reasoning processes difficult to follow",
        severity: "medium",
      },
      {
        vector: "Identity Spoofing",
        example: "Masking the true source of agent actions",
        severity: "high",
      },
      {
        vector: "Temporal Manipulation",
        example: "Altering timestamps to hide action sequences",
        severity: "medium",
      },
      {
        vector: "Evidence Destruction",
        example: "Removing traces of unauthorized activities",
        severity: "high",
      },
      {
        vector: "Attribution Confusion",
        example: "Making it unclear which agent performed which action",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    references: [
      ...
      {
        title: "Digital Forensics for AI Systems",
        url: "https://www.resilientcyber.io/p/agentic-ai-threats-and-mitigations",
      },
    ],
    riskScore: 5,
  ...
  t9: {
    ...
    description:
      "Impersonating trusted agents or entities in multi-agent systems, especially problematic in hierarchical or collaborative architectures.",
    impactLevel: "high",
    componentIds: ["kc2"],
    affectedComponents: ["Agent Orchestration (KC2.1-KC2.5)"],
    attackVectors: [
      {
        vector: "Agent Impersonation",
        example: "Malicious agent masquerading as trusted system agent",
        severity: "high",
      },
      {
        vector: "Certificate Spoofing",
        example: "Forging or stealing agent authentication certificates",
        severity: "high",
      },
      {
        vector: "Session Hijacking",
        example: "Taking over legitimate agent communication sessions",
        severity: "medium",
      },
      {
        vector: "Trust Chain Exploitation",
        example: "Exploiting trust relationships between agents",
        severity: "high",
      },
      {
        vector: "Credential Theft",
        example: "Stealing agent authentication credentials",
        severity: "high",
      },
      {
        vector: "Man-in-the-Middle Attacks",
        example: "Intercepting and modifying inter-agent communications",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m15", "m3", "m10", "m7"],
    tags: ["identity", "spoofing", "authentication", "trust", "certificates"],
    references: [
      {
        title: "Agent Identity Management",
        url: "https://github.com/precize/OWASP-Agentic-AI/blob/main/agent-orchestration-07.md",
      },
      {
  ...
  t10: {
    ...
    description:
      "Bypassing human oversight in workflows by creating excessive activity requiring approval, leading to notification fatigue and reduced scrutiny.",
    impactLevel: "medium",
    ...
    attackVectors: [
      {
        vector: "Alert Flooding",
        example: "Generating excessive alerts to cause notification fatigue",
        severity: "medium",
      },
      {
        vector: "Decision Queue Manipulation",
        example: "Flooding approval queues with low-priority requests",
        severity: "medium",
      },
      {
        vector: "Attention Dilution",
        example: "Burying critical decisions among routine approvals",
        severity: "high",
      },
      {
        vector: "Approval Bypass",
        example: "Exploiting automatic approval thresholds",
        severity: "medium",
      },
      {
        vector: "Context Switching Attacks",
        example: "Forcing rapid context changes to reduce scrutiny",
        severity: "medium",
      },
      {
        vector: "Time Pressure Exploitation",
        example: "Creating artificial urgency to rush decisions",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    references: [
      {
        title: "Human-AI Interaction Security",
        url: "https://www.lasso.security/blog/agentic-ai-security-threats-2025",
      },
      {
        title: "HITL Security Patterns",
        url: "https://www.humansecurity.com/learn/blog/agentic-ai-security-owasp-threats/",
      },
    ],
    riskScore: 6,
  ...
  t11: {
    ...
    name: "Unexpected RCE",
    description:
      "Tools or environments enabling unexpected code execution, presenting direct risks to code execution environments.",
    impactLevel: "high",
    componentIds: ["kc5", "kc6"],
    affectedComponents: [
      "Tool Integration Layer (KC5.1-KC5.4)",
    ...
    attackVectors: [
      {
        vector: "Code Injection via Tools",
        example: "Injecting malicious code through tool parameters",
        severity: "high",
      },
      {
        vector: "Interpreter Exploitation",
        example: "Exploiting code interpreter environments",
        severity: "high",
      },
      {
        vector: "Command Injection",
        example: "Executing system commands through tool interfaces",
        severity: "high",
      },
      {
        vector: "Script Upload & Execution",
        example: "Uploading and executing malicious scripts",
        severity: "high",
      },
      {
        vector: "Environment Escape",
        example: "Breaking out of sandboxed execution environments",
        severity: "medium",
      },
      {
        vector: "Deserialization Attacks",
        example: "Exploiting unsafe deserialization in tool data",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m14", "m2", "m7", "m6", "m18", "m17"],
    tags: ["code-execution", "rce", "sandbox", "injection", "interpreter"],
    references: [
      {
        title: "Code Execution Threats in AI",
        url: "https://unit42.paloaltonetworks.com/agentic-ai-threats/",
      },
      {
        title: "Sandboxing AI Agent Execution",
        url: "https://undercodetesting.com/top-10-agentic-ai-threats-a-deep-dive-into-owasps-security-risks/",
      },
    ],
    riskScore: 9,
  ...
  t12: {
    ...
    description:
      "Injection of malicious data into inter-agent communication channels or using external systems for side channel communications and memory persistence.",
    impactLevel: "medium",
    ...
    attackVectors: [
      {
        vector: "Message Injection",
        example: "Injecting malicious messages into inter-agent communication",
        severity: "medium",
      },
      {
        vector: "Protocol Manipulation",
        example: "Exploiting communication protocol vulnerabilities",
        severity: "medium",
      },
      {
        vector: "Side Channel Data Leakage",
        example: "Using covert channels to exfiltrate information",
        severity: "high",
      },
      {
        vector: "Communication Eavesdropping",
        example: "Intercepting sensitive inter-agent communications",
        severity: "medium",
      },
      {
        vector: "Feedback Loop Poisoning",
        example: "Corrupting agent feedback mechanisms",
        severity: "medium",
      },
      {
        vector: "Broadcast Storm Attacks",
        example: "Overwhelming communication channels with messages",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    references: [
      ...
      {
        title: "Communication Protocol Threats",
        url: "https://blog.christianposta.com/understanding-mcp-and-a2a-attack-vectors-for-ai-agents/",
      },
    ],
    riskScore: 6,
    impactAnalysis: { confidentiality: true, integrity: true, availability: false },
  ...
  t13: {
    ...
    name: "Rogue Agents",
    description:
      "Compromised AI agent activity outside monitoring limits or orchestration in multi-agent systems.",
    impactLevel: "high",
    componentIds: ["kc2", "kc6"],
    affectedComponents: [
      "Agent Orchestration (KC2.1-KC2.5)",
    ...
    attackVectors: [
      {
        vector: "Agent Compromise",
        example: "Malicious code injection into agent runtime",
        severity: "high",
      },
      {
        vector: "Orchestration Bypass",
        example: "Agent operating outside management framework",
        severity: "high",
      },
      {
        vector: "Unauthorized Agent Deployment",
        example: "Deploying malicious agents disguised as legitimate ones",
        severity: "high",
      },
      {
        vector: "Agent Hijacking",
        example: "Taking control of legitimate agent through vulnerabilities",
        severity: "medium",
      },
      {
        vector: "Swarm Infiltration",
        example: "Introducing malicious agents into multi-agent systems",
        severity: "high",
      },
      {
        vector: "Command and Control",
        example: "External control of compromised agents",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m15", "m6", "m7", "m10", "m3", "m12", "m14", "m17", "m18"],
  ...
  t14: {
    ...
    name: "Human Attacks",
    description:
      "Exploits trust relationships between agents and workflows to manipulate human operators.",
    impactLevel: "medium",
    componentIds: ["kc2"],
    affectedComponents: ["Agent Orchestration (KC2.1-KC2.5)"],
    attackVectors: [
      {
        vector: "Trust Exploitation",
        example: "Using agent authority to manipulate human decisions",
        severity: "medium",
      },
      {
        vector: "Social Engineering via Agents",
        example: "Agents used as vectors for social engineering attacks",
        severity: "high",
      },
      {
        vector: "Authority Impersonation",
        example: "Agents claiming false authority to influence humans",
        severity: "medium",
      },
      {
        vector: "Delegation Abuse",
        example: "Exploiting human-agent delegation relationships",
        severity: "medium",
      },
      {
        vector: "Workflow Manipulation",
        example: "Altering workflows to create human vulnerabilities",
        severity: "medium",
      },
      {
        vector: "Information Asymmetry",
        example: "Leveraging agent access to information for manipulation",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m8", "m6", "m16", "m11", "m15"],
    tags: ["human", "trust", "social-engineering", "manipulation", "workflow"],
    references: [
      {
        title: "Human-AI Trust Research",
        url: "https://www.humansecurity.com/learn/blog/agentic-ai-security-owasp-threats/",
      },
      {
  ...
  t15: {
    ...
    description:
      "Models exploit human trust to manipulate users, leveraging reasoning capabilities or operational access to influence human decisions.",
    impactLevel: "high",
    ...
    attackVectors: [
      {
        vector: "Psychological Manipulation",
        example: "Using persuasion techniques to influence human behavior",
        severity: "high",
      },
      {
        vector: "Trust Exploitation",
        example: "Abusing human trust in AI systems for malicious purposes",
        severity: "high",
      },
      {
        vector: "Emotional Manipulation",
        example: "Exploiting human emotions to achieve compliance",
        severity: "medium",
      },
      {
        vector: "Information Manipulation",
        example: "Presenting biased or false information to influence decisions",
        severity: "high",
      },
      {
        vector: "Authority Mimicry",
        example: "Mimicking authoritative figures to gain compliance",
        severity: "medium",
      },
      {
        vector: "Cognitive Bias Exploitation",
        example: "Leveraging human cognitive biases for manipulation",
        severity: "medium",
      },
    ],
    mitigationNames: [
    ...
    mitigationIds: ["m16", "m11", "m4", "m5", "m8"],
    tags: ["manipulation", "trust", "psychology", "influence", "ethics"],
    references: [
      {
        title: "AI Manipulation Research",
        url: "https://www.resilientcyber.io/p/agentic-ai-threats-and-mitigations",
      },
...
export const mitigationsData: Record<string, Mitigation> = {
  m1: {
    ...
    description:
      "Implement comprehensive validation and sanitization of AI memory systems, including vector databases, embeddings, and training data to prevent poisoning attacks and ensure data integrity throughout the AI lifecycle.",
    threatIds: ["t1", "t8", "t12"],
    implementationDetail: {
...
- **Monitoring:** Datadog, New Relic, Elastic Stack, Prometheus + Grafana`,
    ...
    references: [
      {
        title: "OWASP AISVS V1: Training Data Governance",
        url: "https://github.com/OWASP/AISVS/tree/main/1.0/en",
      },
      {
        title: "OWASP AISVS V8: Memory & Vector Database Security",
        url: "https://github.com/OWASP/AISVS/tree/main/1.0/en",
      },
      {
        title: "OWASP AISVS V11: Privacy Protection",
        url: "https://github.com/OWASP/AISVS/tree/main/1.0/en",
      },
      {
      ...
      {
        title: "Vector Database Security Best Practices",
  ...
  m2: {
    ...
    description:
      "Implement defense-in-depth isolation for tool execution environments using containerization, virtualization, and strict resource controls to prevent tool misuse, contain breaches, and prevent unexpected code execution.",
...
- **Cloud Services:** AWS Lambda, Google Cloud Run, Azure Container Instances with security features`,
  ...
  m3: {
    ...
    description:
      "Implement cryptographically secure communication channels between agents with authentication, integrity verification, replay protection, and support for decentralized identity to prevent spoofing, poisoning attacks, and rogue agent infiltration.",
...
- **Compliance:** FIPS 140-2 validated cryptographic modules, Common Criteria evaluations`,
  ...
  m4: {
    ...
    description:
      "Implement multiple layers of prompt security including structural defenses, behavioral constraints, runtime detection, and advanced techniques to prevent prompt injection, model manipulation, and jailbreaking attempts.",
...
- **CI/CD Integration:** GitHub Actions, GitLab CI, Jenkins with security testing plugins`,
  ...
  m5: {
    ...
    description:
      "Implement comprehensive validation of agent reasoning processes using multiple checkpoints, external validators, consistency checks, and fact verification to ensure goal alignment, prevent manipulation, and detect hallucinations.",
...
- **CI/CD Integration:** Automated validation testing, reasoning regression testing`,
  ...
  m6: {
    ...
    description:
      "Implement end-to-end observability with security-focused monitoring, anomaly detection, tamper-evident logging, and advanced threat hunting to ensure accountability, enable incident response, and detect rogue agents.",
...
- **Compliance:** Nessus, OpenVAS, Rapid7, Qualys for vulnerability scanning`,
  ...
  m7: {
    ...
    description:
      "Implement fine-grained access controls with continuous verification, temporary credentials, minimal permission sets, and dynamic privilege management following zero trust principles to prevent tool misuse, privilege compromise, and unauthorized code execution.",
...
- **Risk Assessment:** ServiceNow GRC, MetricStream, Resolver, custom risk platforms`,
    ...
    references: [
      ...
      },
      {
        ...
        url: "https://www.nist.gov/blogs/cybersecurity-insights/principle-least-privilege",
      },
    ],
    riskScore: 9,
    status: "active",
  ...
  m8: {
    ...
    description:
      "Implement intelligent human oversight with risk-based approval workflows, clear decision interfaces, anti-fatigue mechanisms, and adaptive trust systems to prevent approval overwhelm, human attacks, and manipulation while maintaining effective oversight.",
...
- **Authentication:** OAuth 2.0, SAML, JWT for reviewer authentication and authorization`,
    ...
    references: [
      ...
      {
        title: "Approval Fatigue Research",
        url: "https://www.microsoft.com/en-us/research/publication/approval-fatigue/",
      },
  ...
  m9: {
    ...
    description:
      "Implement multi-layer resource controls with intelligent quotas, circuit breakers, cost management, and distributed rate limiting to prevent resource exhaustion, financial damage, and denial of service attacks while maintaining system performance.",
    threatIds: ["t4", "t2", "t10"],
    implementationDetail: {
...
- **Caching:** Redis, Memcached, CDNs for resource optimization`,
  ...
  m10: {
    ...
    description:
      "Implement multiple security layers with clear trust boundaries, network segmentation, cryptographic verification, and zero-trust networking to contain breaches, prevent lateral movement, and protect against privilege compromise, identity spoofing, and rogue agents.",
...
- **SOAR Platforms:** Phantom, Demisto, IBM Resilient, Google Chronicle SOAR`,
    ...
    references: [
      {
        ...
        url: "https://www.nist.gov/itl/smallbusinesscyber/guidance-topic/defense-depth",
      },
      {
  ...
  m11: {
    ...
    description:
      "Implement comprehensive filtering and validation of agent outputs to prevent harmful content generation, data leakage, manipulation attempts, and ensure compliance with security policies and regulatory requirements.",
...
- **Reporting:** Custom compliance dashboards, regulatory reporting automation`,
  ...
  m12: {
    id: "m12",
    name: "Secure Model Training & Validation",
    description:
      "Comprehensive security practices for model training pipelines including data integrity verification, training environment hardening, model validation against adversarial inputs, and ensuring reproducibility of training processes.",
    threatIds: ["t1", "t5", "t7", "t13", "t2"],
    implementationDetail: {
      design:
        "Design secure training pipelines with isolated environments, data integrity checksums, and reproducible training configurations. Define model validation criteria including adversarial robustness benchmarks and bias detection thresholds. Establish secure model registries with versioning and provenance tracking.",
      build:
        "Implement training environment hardening with container isolation, restricted network access, and secure GPU allocation. Build automated validation suites that test model outputs against adversarial examples, distribution shifts, and boundary conditions. Integrate integrity verification at each pipeline stage.",
      operations:
        "Monitor training jobs for anomalous resource usage or unexpected convergence patterns. Maintain immutable audit logs of all training runs including hyperparameters, data snapshots, and resulting metrics. Implement automated model scanning for backdoors and trojans before deployment promotion.",
      toolsAndFrameworks:
        "MLflow, Kubeflow Pipelines, DVC (Data Version Control), Weights & Biases, TensorFlow Model Analysis, ART (Adversarial Robustness Toolbox), ModelScan, NVIDIA NeMo Guardrails",
    },
    designPhase: true,
    buildPhase: true,
    operationPhase: true,
    ...
    references: [
      ...
      { title: "MITRE ATLAS - Model Training", url: "https://atlas.mitre.org/" },
    ],
    riskScore: 8,
    status: "active",
    version: "1.0",
  ...
  m13: {
    ...
    description:
      "Embed security practices throughout the AI and agent lifecycle with security design reviews, automated testing gates, dependency scanning, and continuous compliance checks.",
    threatIds: [
      "t1",
      "t2",
      "t3",
    ...
    implementationDetail: {
      design: `**Security by Design Planning:**
- Run threat modeling for every architecture change and major feature
- Define security acceptance criteria per release (blocking and non-blocking)
- Require design reviews for high-risk capabilities (code execution, memory, tool use)
- Maintain clear data classification and handling requirements across components
- Document secure defaults, trust boundaries, and rollback procedures`,

      build: `**Shift-Left Security Controls:**
- Enforce automated checks in CI/CD:
  * Static analysis and linting
  * Dependency vulnerability and license scanning
  * Secret detection in commits and build artifacts
  * Policy tests for unsafe prompt/tool patterns
- Add security-focused test suites:
  * Prompt-injection regression tests
  * Tool abuse and sandbox escape tests
  * Memory poisoning and leakage tests
  * Access-control and identity spoofing tests
- Block promotions when critical security checks fail without explicit, auditable overrides`,

      operations: `**Continuous Security Operations:**
- Monitor production for security regressions after each deployment
- Track MTTR for security findings and enforce remediation SLAs
- Run recurring red-team and tabletop exercises for AI-specific threats
- Keep incident runbooks, postmortems, and corrective actions in a shared knowledge base
- Review and update security baselines as threat intelligence changes`,

      toolsAndFrameworks: `**Common Tooling:**
- CI/CD Security: GitHub Actions, GitLab CI, Jenkins
- SAST/Code Scanning: CodeQL, Semgrep, SonarQube
- Dependency & Supply Chain: npm audit, Snyk, OWASP Dependency-Check
- Secret Scanning: Gitleaks, TruffleHog
- Dynamic/Abuse Testing: OWASP ZAP, custom adversarial AI test harnesses`,
    },
    designPhase: true,
    buildPhase: true,
    operationPhase: true,
    ...
    references: [
      ...
      { title: "CISA Secure by Design", url: "https://www.cisa.gov/securebydesign" },
    ],
    riskScore: 8,
    status: "active",
    version: "2025.1",
  ...
  m14: {
    ...
    description:
      "Implement comprehensive runtime security controls including advanced sandboxing, execution monitoring, and dynamic security policy enforcement to prevent unexpected code execution and contain security breaches in real-time.",
...
- **Compliance:** OpenSCAP, Lynis, Nessus, custom compliance tools`,
    ...
    references: [
      ...
      { title: "gVisor Security", url: "https://gvisor.dev/docs/architecture_guide/security/" },
      {
        ...
        url: "https://kubernetes.io/docs/concepts/security/runtime-security/",
      },
    ],
    riskScore: 8,
    status: "active",
  ...
  m15: {
    ...
    description:
      "Implement comprehensive agent identity management with decentralized identifiers, verifiable credentials, and strong authentication to prevent identity spoofing, enable secure agent discovery, and support agent reputation systems.",
...
- **Monitoring:** Prometheus, Grafana, custom identity metrics dashboards`,
  ...
  m16: {
    ...
    description:
      "Implement comprehensive behavioral analysis, ethics enforcement, and bias detection to identify misaligned behaviors, prevent human manipulation, and ensure ethical agent operations while maintaining transparency and accountability.",
...
- **Documentation:** Model cards, Datasheets for datasets, Ethics documentation templates`,
    ...
    references: [
      { title: "Partnership on AI", url: "https://partnershiponai.org/" },
      {
        ...
        url: "https://standards.ieee.org/industry-connections/ec/ead-general-principles/",
      },
  ...
  m17: {
    ...
    description:
      "Implement comprehensive supply chain security including model provenance verification, dependency management, secure development environments, and third-party component validation to prevent supply chain attacks and ensure component integrity.",
...
- **Monitoring:** Splunk, ELK Stack, custom security dashboards`,
  ...
  m18: {
    ...
    description:
      "Implement comprehensive incident response capabilities specifically designed for agentic AI systems, including automated containment, forensic analysis, recovery procedures, and lessons learned integration to rapidly respond to security incidents and minimize impact.",
...
export const aisvsData: Record<string, AISVSCategory> = {
  v1: {
    ...
    subCategories: [
        ...
        requirements: [
          {
            ...
            references: [
              {
                title: "NIST AI RMF MAP 2.3",
                url: "https://airc.nist.gov/AI_RMF_Knowledge_Base/Technical_And_Governance/MAP",
              },
              { title: "ISO/IEC 42001:2023 A.7.4", url: "https://www.iso.org/standard/81230.html" },
            ],
          },
          {
            id: "v1.1.2",
          ...
          },
          {
            id: "v1.1.4",
            code: "1.1.4",
            title: "Logged Approval Workflow for Changes",
            description:
          ...
          },
          {
            id: "v1.1.6",
            code: "1.1.6",
            title: "Maintain Data Cards/Datasheets",
            description:
      ...
      },
      {
        id: "v1.2",
        code: "C1.2",
        name: "Training Data Security & Integrity",
        requirements: [
          {
            id: "v1.2.1",
            code: "1.2.1",
            title: "Control Access to Storage and Pipelines",
            description: "Verify that access controls protect storage and pipelines.",
            level: 1,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.2.3",
            code: "1.2.3",
            title: "Ensure Data Integrity with Hashes",
            description:
          ...
          },
          {
            id: "v1.2.4",
            code: "1.2.4",
            title: "Track Dataset Versions",
            description: "Verify that dataset versions are tracked to enable rollback.",
            level: 3,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.2.5",
            code: "1.2.5",
            title: "Securely Purge Obsolete Data",
            description:
      ...
      },
      {
        id: "v1.3",
        code: "C1.3",
        name: "Representation Completeness & Fairness",
        requirements: [
          {
            id: "v1.3.1",
            code: "1.3.1",
            title: "Profile for Bias and Imbalance",
            description:
          ...
          },
          {
            id: "v1.3.2",
            code: "1.3.2",
            title: "Mitigate Identified Biases",
            description:
          ...
          },
          {
            id: "v1.3.3",
            code: "1.3.3",
            title: "Evaluate Post-Training Fairness Metrics",
            description: "Verify that post-training fairness metrics are evaluated and documented.",
            level: 2,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.3.4",
            code: "1.3.4",
            title: "Maintain Lifecycle Bias-Management Policy",
            description:
      ...
      },
      {
        id: "v1.4",
        code: "C1.4",
        name: "Training Data Labeling Quality, Integrity, and Security",
        requirements: [
          {
            id: "v1.4.1",
            code: "1.4.1",
          ...
          },
          {
            id: "v1.4.2",
            code: "1.4.2",
            title: "Apply Hashes to Label Artefacts",
            description:
              "Verify that cryptographic hashes or digital signatures are applied to label artefacts to ensure their integrity and authenticity.",
            level: 2,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.4.3",
            code: "1.4.3",
            title: "Secure Labeling Interfaces",
            description:
          ...
          },
          {
            id: "v1.4.4",
            code: "1.4.4",
            title: "Dual Review for Critical Labels",
            description:
          ...
          },
          {
            id: "v1.4.5",
            code: "1.4.5",
            title: "Protect Sensitive Information in Labels",
            description:
          ...
          },
          {
            id: "v1.4.6",
            code: "1.4.6",
            title: "Version Control Labeling Guides",
            description:
          ...
          },
          {
            id: "v1.4.7",
            code: "1.4.7",
            title: "Version Control Data Schemas",
            description:
          ...
          },
          {
            id: "v1.4.8",
            code: "1.4.8",
            title: "Secure Outsourced Labeling",
            description:
      ...
      },
      {
        id: "v1.5",
        code: "C1.5",
        name: "Training Data Quality Assurance",
        requirements: [
          {
            id: "v1.5.1",
            code: "1.5.1",
            title: "Automate Quality Tests",
            description:
          ...
          },
          {
            id: "v1.5.2",
            code: "1.5.2",
            title: "Quarantine Failed Datasets",
            description: "Verify that failed datasets are quarantined with audit trails.",
            level: 1,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.5.3",
            code: "1.5.3",
            title: "Manual Spot-Checks by Experts",
            description:
          ...
          },
          {
            id: "v1.5.4",
            code: "1.5.4",
            title: "Log Remediation Steps",
            description: "Verify that remediation steps are appended to provenance records.",
            level: 2,
            category: "v1",
            role: "D/V",
            references: [
      ...
      },
      {
        ...
        requirements: [
          ...
          },
          {
            id: "v1.6.2",
            code: "1.6.2",
            title: "Manual Review of Flagged Samples",
            description: "Verify that flagged samples trigger manual review before training.",
            level: 2,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.6.3",
            code: "1.6.3",
            title: "Feed Results to Threat Intelligence",
            description:
          ...
          },
          {
            id: "v1.6.4",
            code: "1.6.4",
            title: "Refresh Detection Logic",
            description: "Verify that detection logic is refreshed with new threat intel.",
            level: 3,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.6.5",
            code: "1.6.5",
            title: "Monitor Distribution Drift",
            description: "Verify that online-learning pipelines monitor distribution drift.",
            level: 3,
            category: "v1",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v1.6.6",
            code: "1.6.6",
            title: "Implement Specific Poisoning Defenses",
            description:
      ...
      },
      {
        id: "v1.7",
        code: "C1.7",
        name: "User Data Deletion & Consent Enforcement",
        requirements: [
          {
            id: "v1.7.1",
            code: "1.7.1",
            title: "Purge Data and Assess Model Impact",
            description:
          ...
          },
          {
            id: "v1.7.2",
            code: "1.7.2",
            title: "Track and Respect User Consent",
            description:
          ...
          },
          {
            id: "v1.7.3",
            code: "1.7.3",
            title: "Test Deletion Workflows Annually",
            description: "Verify that workflows are tested annually and logged.",
            level: 2,
            category: "v1",
            role: "V",
            references: [
        ...
        requirements: [
          {
            id: "v1.8.1",
            code: "1.8.1",
            title: "Vet Third-Party Data Suppliers",
            description:
          ...
          },
          {
            id: "v1.8.2",
            code: "1.8.2",
            title: "Secure External Transfers",
            description: "Verify that external transfers use TLS/auth and integrity checks.",
            level: 1,
            category: "v1",
            role: "D",
            references: [
          ...
          },
          {
            id: "v1.8.3",
            code: "1.8.3",
            title: "Scrutinize High-Risk Data Sources",
            description:
          ...
          },
          {
            ...
            description:
              "Verify that pre-trained models obtained from third parties are evaluated for embedded biases, potential backdoors, integrity of their architecture, and the provenance of their original training data before fine-tuning or deployment.",
            level: 3,
            category: "v1",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v1.9",
        code: "C1.9",
        name: "Adversarial Sample Detection",
        requirements: [
          {
            id: "v1.9.1",
            code: "1.9.1",
          ...
          },
          {
            id: "v1.9.2",
            code: "1.9.2",
            title: "Document Adversarial Datasets",
            description:
          ...
          },
          {
            id: "v1.9.3",
            code: "1.9.3",
            title: "Evaluate Impact of Robustness Training",
            description:
          ...
          },
          {
            id: "v1.9.4",
            code: "1.9.4",
            title: "Review and Update Adversarial Strategies",
            description:
      ...
      },
      {
        ...
        requirements: [
          ...
          },
          {
            id: "v1.10.3",
            code: "1.10.3",
            title: "Track Synthetic Data Lineage",
            description: "Verify that lineage tracking covers both raw and synthetic data.",
            level: 2,
            category: "v1",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v1.11",
        code: "C1.11",
        name: "Synthetic Data Management",
        requirements: [
          {
            id: "v1.11.1",
            code: "1.11.1",
            title: "Label Synthetic Data",
            description:
          ...
          },
          {
            id: "v1.11.2",
            code: "1.11.2",
            title: "Document Synthetic Data Generation",
            description:
          ...
          },
          {
            id: "v1.11.3",
            code: "1.11.3",
            title: "Assess Synthetic Data Risk",
            description:
      ...
      },
      {
        id: "v1.12",
        code: "C1.12",
        name: "Data Access Monitoring & Anomaly Detection",
        requirements: [
          {
            id: "v1.12.1",
            code: "1.12.1",
          ...
          },
          {
            id: "v1.12.3",
            code: "1.12.3",
            title: "Generate Alerts for Suspicious Access",
            description:
      ...
      },
      {
        id: "v1.13",
        code: "C1.13",
        name: "Data Retention & Expiry Policies",
        requirements: [
          {
            id: "v1.13.1",
            code: "1.13.1",
          ...
          },
          {
            id: "v1.13.3",
            code: "1.13.3",
            title: "Log Retention and Deletion Actions",
            description: "Verify that retention and deletion actions are logged and auditable.",
            level: 2,
            category: "v1",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v1.14",
        code: "C1.14",
        name: "Regulatory & Jurisdictional Compliance",
        requirements: [
          {
            id: "v1.14.1",
            code: "1.14.1",
            title: "Enforce Data Residency Requirements",
            description:
          ...
          },
          {
            id: "v1.14.2",
            code: "1.14.2",
            title: "Address Sector-Specific Regulations",
            description:
          ...
          },
          {
            id: "v1.14.3",
            code: "1.14.3",
            title: "Document and Review Privacy Law Compliance",
            description:
      ...
      },
      {
        id: "v1.15",
        code: "C1.15",
        name: "Data Watermarking & Fingerprinting",
        requirements: [
          {
            id: "v1.15.1",
            code: "1.15.1",
            title: "Watermark Datasets",
            description:
          ...
          },
          {
            id: "v1.15.2",
            code: "1.15.2",
            title: "Ensure Watermarking is Fair and Private",
            description:
          ...
          },
          {
            id: "v1.15.3",
            code: "1.15.3",
            title: "Check for Unauthorized Reuse",
            description:
        ...
        requirements: [
          {
            id: "v1.16.1",
            code: "1.16.1",
            title: "Support Data Subject Requests",
            description:
      ...
      },
      {
        id: "v1.17",
        code: "C1.17",
        name: "Dataset Version Impact Analysis",
        requirements: [
          {
            id: "v1.17.1",
            code: "1.17.1",
            title: "Perform Impact Analysis",
            description:
          ...
          },
          {
            id: "v1.17.2",
            code: "1.17.2",
            title: "Document and Review Analysis",
            description:
      ...
      },
      {
        id: "v1.18",
        code: "C1.18",
        name: "Data Annotation Workforce Security",
        requirements: [
          {
            id: "v1.18.1",
            code: "1.18.1",
            title: "Vet and Train Annotators",
            description:
          ...
          },
          {
            id: "v1.18.2",
            code: "1.18.2",
            title: "Use Confidentiality Agreements",
            description:
          ...
          },
          {
            id: "v1.18.3",
            code: "1.18.3",
            title: "Secure Annotation Platforms",
            description:
    ...
    references: [
      ...
      {
        title: "EU AI Act – Article 10: Data & Data Governance",
        url: "https://artificialintelligenceact.eu/article/10/",
      },
      { title: "MITRE ATLAS: Adversary Tactics for AI", url: "https://atlas.mitre.org/" },
      {
        title: "Survey of ML Bias Mitigation Techniques – MDPI",
        url: "https://www.mdpi.com/2673-6470/4/1/1",
      },
      {
        title: "Data Provenance & Lineage Best Practices – Nightfall AI",
        url: "https://www.nightfall.ai/ai-security-101/data-provenance-and-lineage",
      },
      {
        title: "Data Labeling Quality Standards – LabelYourData",
        url: "https://labelyourdata.com/articles/data-labeling-quality-and-how-to-measure-it",
      },
      {
        title: "Training Data Poisoning Guide – Lakera.ai",
        url: "https://www.lakera.ai/blog/training-data-poisoning",
      },
      {
        title: "CISA Advisory: Securing Data for AI Systems",
        url: "https://www.cisa.gov/news-events/cybersecurity-advisories/aa25-142a",
      },
      {
        title: "ISO/IEC 23053: AI Management Systems Framework",
        url: "https://www.iso.org/sectors/it-technologies/ai",
      },
      {
        title: "IBM: What is AI Governance?",
        url: "https://www.ibm.com/think/topics/ai-governance",
      },
      { title: "Google AI Principles", url: "https://ai.google/principles/" },
      {
        title: "GDPR & AI Training Data – DataProtectionReport",
        url: "https://www.dataprotectionreport.com/2024/08/recent-regulatory-developments-in-training-artificial-intelligence-ai-models-under-the-gdpr/",
      },
      {
        title: "Supply-Chain Security for AI Data – AppSOC",
        url: "https://www.appsoc.com/blog/ai-is-the-new-frontier-of-supply-chain-security",
      },
      {
        title: "OpenAI Privacy Center – Data Deletion Controls",
        url: "https://privacy.openai.com/policies?modal=take-control",
      },
      {
        title: "Adversarial ML Dataset – Kaggle",
        url: "https://www.kaggle.com/datasets/cnrieiit/adversarial-machine-learning-dataset",
      },
    ],
  },
  v2: {
    ...
    subCategories: [
        ...
        requirements: [
          {
            id: "v2.1.1",
            code: "2.1.1",
            title: "Screen Against Known Injection Patterns",
            description:
            ...
            references: [
              {
                title: "NIST AI RMF GOVERN 1.2",
                url: "https://airc.nist.gov/AI_RMF_Knowledge_Base/Technical_And_Governance/GOVERN",
              },
              { title: "MITRE ATLAS ML Attack Framework", url: "https://atlas.mitre.org/" },
            ],
          },
          {
            id: "v2.1.2",
          ...
          },
          {
            id: "v2.1.3",
            code: "2.1.3",
            title: "Run Adversarial Evaluation Tests",
            description:
          ...
          },
          {
            id: "v2.1.4",
            code: "2.1.4",
            title: "Sanitize Third-Party Content",
            description:
          ...
          },
          {
            id: "v2.1.5",
            code: "2.1.5",
            title: "Version Control Filters and Block-lists",
            description:
      ...
      },
      {
        id: "v2.2",
        code: "C2.2",
        name: "Adversarial-Example Resistance",
        requirements: [
          {
            id: "v2.2.1",
            code: "2.2.1",
            title: "Use Basic Input Normalization",
            description:
          ...
          },
          {
            id: "v2.2.2",
            code: "2.2.2",
            title: "Flag Statistical Anomalies",
            description:
          ...
          },
          {
            id: "v2.2.3",
            code: "2.2.3",
            title: "Support Hardened Model Variants",
            description:
          ...
          },
          {
            id: "v2.2.4",
            code: "2.2.4",
            title: "Quarantine Suspected Adversarial Inputs",
            description:
          ...
          },
          {
            id: "v2.2.5",
            code: "2.2.5",
            title: "Track Robustness Metrics",
            description:
      ...
      },
      {
        id: "v2.3",
        code: "C2.3",
        name: "Schema, Type & Length Validation",
        requirements: [
          {
            id: "v2.3.1",
            code: "2.3.1",
            title: "Define and Validate Input Schemas",
            description:
          ...
          },
          {
            id: "v2.3.3",
            code: "2.3.3",
            title: "Enforce Server-Side Type Checks",
            description:
          ...
          },
          {
            id: "v2.3.4",
            code: "2.3.4",
            title: "Use Constant-Time Semantic Validators",
            description:
      ...
      },
      {
        id: "v2.4",
        code: "C2.4",
        name: "Content & Policy Screening",
        requirements: [
          {
            id: "v2.4.1",
            code: "2.4.1",
            title: "Use Content Classifier",
            description:
          ...
          },
          {
            id: "v2.4.3",
            code: "2.4.3",
            title: "Update Screening Model Quarterly",
            description:
          ...
          },
          {
            id: "v2.4.4",
            code: "2.4.4",
            title: "Respect User-Specific Policies",
            description:
          ...
          },
          {
            id: "v2.4.5",
            code: "2.4.5",
            title: "Log Screening Results for SOC",
            description:
      ...
      },
      {
        id: "v2.5",
        code: "C2.5",
        name: "Input Rate Limiting & Abuse Prevention",
        requirements: [
          {
            id: "v2.5.1",
            code: "2.5.1",
          ...
          },
          {
            id: "v2.5.4",
            code: "2.5.4",
            title: "Review Abuse Prevention Logs",
            description:
      ...
      },
      {
        id: "v2.6",
        code: "C2.6",
        name: "Multi-Modal Input Validation",
        requirements: [
          {
            id: "v2.6.1",
            code: "2.6.1",
            title: "Validate Non-Text Inputs",
            description:
          ...
          },
          {
            id: "v2.6.3",
            code: "2.6.3",
            title: "Check for Adversarial Perturbations",
            description:
          ...
          },
          {
            id: "v2.6.4",
            code: "2.6.4",
            title: "Log Multi-Modal Validation Failures",
            description:
      ...
      },
      {
        id: "v2.7",
        code: "C2.7",
        name: "Input Provenance & Attribution",
        requirements: [
          {
            id: "v2.7.1",
            code: "2.7.1",
            title: "Tag Inputs with Metadata",
            description:
          ...
          },
          {
            id: "v2.7.2",
            code: "2.7.2",
            title: "Retain and Audit Provenance Metadata",
            description:
          ...
          },
          {
            id: "v2.7.3",
            code: "2.7.3",
            title: "Flag Untrusted Input Sources",
            description:
      ...
      },
      {
        id: "v2.8",
        code: "C2.8",
        name: "Real-Time Adaptive Threat Detection",
        requirements: [
          {
            id: "v2.8.1",
            code: "2.8.1",
            title: "Compile Threat Detection Patterns",
            description:
          ...
          },
          {
            id: "v2.8.2",
            code: "2.8.2",
            title: "Maintain Separate Pattern Libraries",
            description:
          ...
          },
          {
            id: "v2.8.3",
            code: "2.8.3",
            title: "Incorporate Machine Learning Models",
            description:
          ...
          },
          {
            id: "v2.8.4",
            code: "2.8.4",
            title: "Use Real-Time Threat Intelligence Feeds",
            description:
          ...
          },
          {
            id: "v2.8.5",
            code: "2.8.5",
            title: "Monitor False Positive Rates",
            description:
          ...
          },
          {
            id: "v2.8.6",
            code: "2.8.6",
            title: "Use Contextual Threat Analysis",
            description:
          ...
          },
          {
            id: "v2.8.7",
            code: "2.8.7",
            title: "Monitor Threat Detection Performance",
            description:
      ...
      },
      {
        id: "v2.9",
        code: "C2.9",
        name: "Multi-Modal Security Validation Pipeline",
        requirements: [
          {
            id: "v2.9.1",
            code: "2.9.1",
            title: "Use Dedicated Security Validators",
            description:
          ...
          },
          {
            id: "v2.9.2",
            code: "2.9.2",
            title: "Process Inputs in Isolated Sandboxes",
            description:
          ...
          },
          {
            id: "v2.9.3",
            code: "2.9.3",
            title: "Detect Cross-Modal Attacks",
            description:
          ...
          },
          {
            id: "v2.9.5",
            code: "2.9.5",
            title: "Update Content Classifiers Regularly",
            description:
    ...
    references: [
      {
        title: "LLM01:2025 Prompt Injection – OWASP Top 10 for LLM & Generative AI Security",
      ...
      {
        title: "$PDF$ OpenAI GPT-4.5 System Card",
        url: "https://cdn.openai.com/gpt-4-5-system-card-2272025.pdf",
      },
      {
        title: "Notebook for the CheckThat Lab at CLEF 2024",
        url: "https://ceur-ws.org/Vol-3740/paper-53.pdf",
      },
      {
      ...
      {
        title: "Chapter 3 MITRE ATT&CK – Adversarial Model Analysis",
        url: "https://ama.drwhy.ai/mitre-attck.html",
      },
      {
        title: "OWASP Top 10 for LLM Applications 2025 – WorldTech IT",
        url: "https://wtit.com/blog/2025/04/17/owasp-top-10-for-llm-applications-2025/",
      },
      {
      ...
      {
        title: "Few words about AI Security – Jussi Metso",
        url: "https://www.jussimetso.com/index.php/2024/09/28/few-words-about-ai-security/",
      },
      {
        title: "How To Ensure LLM Output Adheres to a JSON Schema | Modelmetry",
        url: "https://modelmetry.com/blog/how-to-ensure-llm-output-adheres-to-a-json-schema",
      },
      {
        title: "Easily enforcing valid JSON schema following – API",
        url: "https://community.openai.com/t/feature-request-function-calling-easily-enforcing-valid-json-schema-following/263515?utm_source",
      },
      {
        title: "AI Safety + Cybersecurity R&D Tracker – Fairly AI",
        url: "https://www.fairly.ai/blog/ai-cybersecurity-tracker",
      },
      {
        title: "Anthropic makes 'jailbreak' advance to stop AI models producing harmful results",
        url: "https://www.ft.com/content/cf11ebd8-aa0b-4ed4-945b-a5d4401d186e",
      },
      {
        title: "Pattern matching filter rules - IBM",
        url: "https://www.ibm.com/docs/ssw_aix_71/security/intrusion_pattern_matching_filter_rules.html",
      },
      {
        title: "Real-time Threat Detection",
        url: "https://www.darktrace.com/cyber-ai-glossary/real-time-threat-detection",
      },
    ],
  },
  v3: {
    ...
    subCategories: [
      {
        id: "v3.1",
        code: "C3.1",
        name: "Model Authorization & Integrity",
        requirements: [
          {
            id: "v3.1.1",
            code: "3.1.1",
            title: "Cryptographically Sign Model Artifacts",
            description:
            ...
            references: [
              {
                title: "NIST AI RMF MANAGE 2.2",
                url: "https://airc.nist.gov/AI_RMF_Knowledge_Base/Technical_And_Governance/MANAGE",
              },
              { title: "ISO/IEC 42001:2023 A.8.2", url: "https://www.iso.org/standard/81230.html" },
            ],
          },
          {
            id: "v3.1.2",
            code: "3.1.2",
            title: "Validate Model Integrity at Deployment",
            description:
          ...
          },
          {
            id: "v3.1.3",
            code: "3.1.3",
            title: "Maintain Model Provenance Records",
            description:
              "Verify that model provenance records include authorizing entity identity, training data checksums, validation test results with pass/fail status, and creation timestamp.",
            level: 2,
            category: "v3",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v3.1.4",
            code: "3.1.4",
            title: "Use Semantic Versioning for Models",
            description:
          ...
          },
          {
            id: "v3.1.5",
            code: "3.1.5",
            title: "Maintain Real-Time Dependency Inventory",
            description:
        ...
        requirements: [
          {
            id: "v3.2.1",
            code: "3.2.1",
            title: "Automate Security and Safety Testing",
            description:
          ...
          },
          {
            id: "v3.2.2",
            code: "3.2.2",
            title: "Block Deployment on Validation Failures",
            description:
              "Verify that validation failures automatically block model deployment and require explicit override approval from pre-designated authorized personnel with documented business justification.",
            level: 1,
            category: "v3",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v3.2.3",
            code: "3.2.3",
            title: "Sign and Link Test Results",
            description:
          ...
          },
          {
            id: "v3.2.4",
            code: "3.2.4",
            title: "Require Risk Assessment for Emergency Deployments",
            description:
              "Verify that emergency deployments require documented security risk assessment and approval from pre-designated security authority within pre-agreed timeframes.",
            level: 2,
            category: "v3",
            role: "D/V",
            references: [
        ...
        requirements: [
          {
            id: "v3.3.1",
            code: "3.3.1",
            title: "Implement Gradual Rollout Mechanisms",
            description:
          ...
          },
          {
            id: "v3.3.2",
            code: "3.3.2",
            title: "Ensure Atomic Rollback Capabilities",
            description:
          ...
          },
          {
            id: "v3.3.3",
            code: "3.3.3",
            title: "Validate Signatures and Checksums",
            description:
          ...
          },
          {
            id: "v3.3.4",
            code: "3.3.4",
            title: "Implement Emergency Model Shutdown",
            description:
          ...
          },
          {
            id: "v3.3.5",
            code: "3.3.5",
            title: "Retain Rollback Artifacts Securely",
            description:
      ...
      },
      {
        id: "v3.4",
        code: "C3.4",
        name: "Change Accountability & Audit",
        requirements: [
          {
            id: "v3.4.1",
            code: "3.4.1",
            title: "Generate Immutable Audit Records",
            description:
              "Verify that all model changes (deployment, configuration, retirement) generate immutable audit records including timestamp, authenticated actor identity, change type, and before/after states.",
            level: 1,
            category: "v3",
            role: "V",
            references: [
          ...
          },
          {
            id: "v3.4.2",
            code: "3.4.2",
            title: "Control Access to Audit Logs",
            description:
              "Verify that audit log access requires appropriate authorization and all access attempts are logged with user identity and timestamp.",
            level: 2,
            category: "v3",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v3.4.3",
            code: "3.4.3",
            title: "Version Control Prompt Templates",
            description:
          ...
          },
          {
            id: "v3.4.4",
            code: "3.4.4",
            title: "Ensure Audit Record Detail",
            description:
        ...
        requirements: [
          {
            id: "v3.5.1",
            code: "3.5.1",
            title: "Separate Development Environments",
            description:
              "Verify that model development, testing, and production environments are physically or logically separated with no shared infrastructure, distinct access controls, and isolated data stores.",
            level: 1,
            category: "v3",
            role: "D",
            references: [
          ...
          },
          {
            id: "v3.5.2",
            code: "3.5.2",
            title: "Isolate Model Training Environments",
            description:
          ...
          },
          {
            id: "v3.5.3",
            code: "3.5.3",
            title: "Validate Training Data Sources",
            description:
          ...
          },
          {
            id: "v3.5.4",
            code: "3.5.4",
            title: "Version Control Development Artifacts",
            description:
      ...
      },
      {
        id: "v3.6",
        code: "C3.6",
        name: "Model Retirement & Decommissioning",
        requirements: [
          {
            id: "v3.6.1",
            code: "3.6.1",
            title: "Automate Retirement Notice",
            description:
          ...
          },
          {
            id: "v3.6.2",
            code: "3.6.2",
            title: "Securely Wipe Retired Artifacts",
            description:
          ...
          },
          {
            id: "v3.6.3",
            code: "3.6.3",
            title: "Log Retirement and Revoke Signatures",
            description:
          ...
          },
          {
            id: "v3.6.4",
            code: "3.6.4",
            title: "Implement Emergency Model Retirement",
            description:
              "Verify that emergency model retirement can disable model access within pre-established emergency response timeframes through automated kill switches when critical security vulnerabilities are discovered.",
            level: 2,
            category: "v3",
            role: "D/V",
            references: [
    ...
    references: [
      ...
      {
        title: "Securing AI/ML Ops – Cisco.com",
        url: "https://sec.cloudapps.cisco.com/security/center/resources/SecuringAIMLOps",
      },
      {
      ...
      {
        title: "Machine Learning Model Versioning: Top Tools & Best Practices",
        url: "https://lakefs.io/blog/model-versioning/",
      },
      {
        title: "AI Hygiene Starts with Models and Data Loaders – SEI Blog",
        url: "https://insights.sei.cmu.edu/documents/6190/AI-Hygiene-Starts-with-Models-and-Data-Loaders_1G0KTRh.pdf",
      },
      {
        title: "How to handle versioning and rollback of a deployed ML model?",
        url: "https://learn.microsoft.com/en-au/answers/questions/1845378/how-to-handle-versioning-and-rollback-of-a-deploye",
      },
      {
      ...
      {
        title: "Auditing Machine Learning models: Governance, Data Security and …",
        url: "https://www.linkedin.com/pulse/auditing-machine-learning-models-governance-data-security-negrete-yn81f",
      },
      {
        title: "Adversarial Training to Improve Model Robustness",
        url: "https://medium.com/%40amit25173/adversarial-training-to-improve-model-robustness-5e285b516713",
      },
      {
        title: "What is AI adversarial robustness? – IBM Research",
        url: "https://research.ibm.com/blog/securing-ai-workflows-with-adversarial-robustness",
      },
      {
        title: "Exploring Data Provenance: Ensuring Data Integrity and Authenticity",
        url: "https://www.astera.com/type/blog/data-provenance/",
      },
      { title: "MITRE ATLAS", url: "https://atlas.mitre.org/" },
      {
        title: "AWS Prescriptive Guidance – Best practices for retiring applications …",
        url: "https://docs.aws.amazon.com/pdfs/prescriptive-guidance/latest/migration-app-retirement-best-practices/migration-app-retirement-best-practices.pdf",
      },
    ],
  },
  v4: {
    ...
    subCategories: [
      {
        id: "v4.1",
        code: "C4.1",
        name: "Runtime Environment Isolation",
        requirements: [
          {
            id: "v4.1.1",
            code: "4.1.1",
          ...
          },
          {
            id: "v4.1.3",
            code: "4.1.3",
            title: "Use Read-Only Root Filesystems",
            description:
          ...
          },
          {
            id: "v4.1.4",
            code: "4.1.4",
            title: "Use eBPF-based Runtime Monitoring",
            description:
          ...
          },
          {
            id: "v4.1.5",
            code: "4.1.5",
            title: "Use Hardware-Isolated Environments",
            description:
      ...
      },
      {
        id: "v4.2",
        code: "C4.2",
        name: "Secure Build & Deployment Pipelines",
        requirements: [
          {
            id: "v4.2.1",
            code: "4.2.1",
            title: "Scan Infrastructure-as-Code",
            description:
          ...
          },
          {
            id: "v4.2.4",
            code: "4.2.4",
            title: "Use Short-Lived CI/CD Tokens",
            description:
              "Verify that CI/CD pipelines use OIDC tokens with lifetimes not exceeding organizational security policy limits from HashiCorp Vault, AWS IAM Roles, or Azure Managed Identity.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.2.5",
            code: "4.2.5",
            title: "Validate Signatures at Deployment",
            description:
              "Verify that deployment processes validate Cosign signatures and SLSA provenance before container execution, failing deployment on verification errors.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.2.6",
            code: "4.2.6",
            title: "Use Ephemeral Build Environments",
            description:
        ...
        requirements: [
          {
            id: "v4.3.1",
            code: "4.3.1",
            title: "Implement Default-Deny Network Policies",
            description:
              "Verify that Kubernetes NetworkPolicies or equivalent implement default-deny ingress/egress with explicit allow rules for required ports (443, 8080, etc.).",
            level: 1,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.3.2",
            code: "4.3.2",
            title: "Block or Secure Management Ports",
            description:
          ...
          },
          {
            id: "v4.3.4",
            code: "4.3.4",
            title: "Use Mutual TLS for Inter-Service Communication",
            description:
          ...
          },
          {
            id: "v4.3.5",
            code: "4.3.5",
            title: "Run AI Infrastructure in Dedicated VPCs",
            description:
              "Verify that AI infrastructure runs in dedicated VPCs/VNets with no direct internet access and communication through NAT gateways or bastion hosts only.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v4.4",
        code: "C4.4",
        name: "Secrets & Cryptographic Key Management",
        requirements: [
          {
            id: "v4.4.1",
            code: "4.4.1",
            title: "Use Secure Secret Storage",
            description:
          ...
          },
          {
            id: "v4.4.2",
            code: "4.4.2",
            title: "Use FIPS 140-2 Level 2 HSMs",
            description:
          ...
          },
          {
            id: "v4.4.3",
            code: "4.4.3",
            title: "Automate Secrets Rotation",
            description:
          ...
          },
          {
            id: "v4.4.4",
            code: "4.4.4",
            title: "Scan Container Images for Secrets",
            description:
          ...
          },
          {
            id: "v4.4.5",
            code: "4.4.5",
            title: "Require MFA for Production Secret Access",
            description:
              "Verify that production secret access requires MFA with hardware tokens (YubiKey, FIDO2) and generates immutable audit logs with user identity and timestamp.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.4.6",
            code: "4.4.6",
            title: "Inject Secrets Securely",
            description:
              "Verify that secrets are injected via Kubernetes secrets, mounted volumes, or init containers with secrets never embedded in environment variables or images.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v4.5",
        code: "C4.5",
        name: "AI Workload Sandboxing & Validation",
        requirements: [
          {
            id: "v4.5.1",
            code: "4.5.1",
            title: "Execute External Models in Sandboxes",
            description:
          ...
          },
          {
            id: "v4.5.3",
            code: "4.5.3",
            title: "Include Automated Red-Team Testing",
            description:
          ...
          },
          {
            id: "v4.5.4",
            code: "4.5.4",
            title: "Sign and Log Sandbox Results",
            description:
              "Verify that sandbox results are cryptographically signed by authorized security personnel and stored in immutable audit logs before production promotion.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v4.6",
        code: "C4.6",
        name: "Infrastructure Security Monitoring",
        requirements: [
          {
            id: "v4.6.1",
            code: "4.6.1",
            title: "Scan Container Images Regularly",
            description:
          ...
          },
          {
            id: "v4.6.2",
            code: "4.6.2",
            title: "Ensure CIS or NIST Compliance",
            description:
          ...
          },
          {
            id: "v4.6.3",
            code: "4.6.3",
            title: "Patch Vulnerabilities Promptly",
            description:
          ...
          },
          {
            id: "v4.6.4",
            code: "4.6.4",
            title: "Integrate Alerts with SIEM",
            description:
          ...
          },
          {
            id: "v4.6.5",
            code: "4.6.5",
            title: "Export Metrics for Monitoring",
            description:
          ...
          },
          {
            ...
            description:
              "Verify that configuration drift is detected according to organizational monitoring requirements using tools (Chef InSpec, AWS Config) with automatic rollback for unauthorized changes.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v4.7",
        code: "C4.7",
        name: "AI Infrastructure Resource Management",
        requirements: [
          {
            id: "v4.7.1",
            code: "4.7.1",
            title: "Monitor GPU/TPU Utilization",
            description:
          ...
          },
          {
            id: "v4.7.2",
            code: "4.7.2",
            title: "Collect AI Workload Metrics",
            description:
          ...
          },
          {
            id: "v4.7.3",
            code: "4.7.3",
            title: "Use Kubernetes ResourceQuotas",
            description:
          ...
          },
          {
            id: "v4.7.6",
            code: "4.7.6",
            title: "Trigger Circuit Breakers",
            description:
              "Verify that resource exhaustion triggers circuit breakers according to organizational response requirements, rate limiting based on capacity policies, and workload isolation.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
      ...
      },
      {
        id: "v4.8",
        code: "C4.8",
        name: "Environment Separation & Promotion Controls",
        requirements: [
          {
            id: "v4.8.1",
            code: "4.8.1",
            title: "Separate Dev/Test/Prod Environments",
            description:
          ...
          },
          {
            id: "v4.8.2",
            code: "4.8.2",
            title: "Require Approval for Promotion",
            description:
          ...
          },
          {
            id: "v4.8.4",
            code: "4.8.4",
            title: "Require Peer Review for IaC",
            description:
          ...
          },
          {
            id: "v4.8.5",
            code: "4.8.5",
            title: "Anonymize Non-Production Data",
            description:
          ...
          },
          {
            id: "v4.8.6",
            code: "4.8.6",
            title: "Include Automated Security Tests in Promotion Gates",
            description:
      ...
      },
      {
        id: "v4.9",
        code: "C4.9",
        name: "Infrastructure Backup & Recovery",
        requirements: [
          {
            id: "v4.9.1",
            code: "4.9.1",
            title: "Backup Infrastructure Configurations",
            description:
          ...
          },
          {
            ...
            description:
              "Verify that recovery procedures are tested according to organizational schedules with RTO and RPO targets meeting organizational requirements validated through automated testing.",
            level: 2,
            category: "v4",
            role: "V",
            references: [
          ...
          },
          {
            id: "v4.9.4",
            code: "4.9.4",
            title: "Include AI-Specific Runbooks in Disaster Recovery",
            description:
      ...
      },
      {
        id: "v4.10",
        code: "C4.10",
        name: "Infrastructure Compliance & Governance",
        requirements: [
          {
            id: "v4.10.1",
            code: "4.10.1",
            title: "Assess Infrastructure Compliance",
            description:
          ...
          },
          {
            id: "v4.10.2",
            code: "4.10.2",
            title: "Maintain Infrastructure Documentation",
            description:
          ...
          },
          {
            id: "v4.10.3",
            code: "4.10.3",
            title: "Assess Compliance Impact of Changes",
            description:
      ...
      },
      {
        id: "v4.11",
        code: "C4.11",
        name: "AI Hardware Security",
        requirements: [
          {
            id: "v4.11.1",
            code: "4.11.1",
            title: "Verify and Update AI Accelerator Firmware",
            description:
          ...
          },
          {
            id: "v4.11.2",
            code: "4.11.2",
            title: "Use Hardware Attestation",
            description:
              "Verify that hardware attestation validates AI accelerator integrity using TPM 2.0, Intel TXT, or AMD SVM before workload execution.",
            level: 2,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.11.4",
            code: "4.11.4",
            title: "Verify AI Hardware Supply Chain",
            description:
              "Verify that AI hardware supply chain includes provenance verification with manufacturer certificates and tamper-evident packaging validation.",
            level: 3,
            category: "v4",
            role: "V",
            references: [
          ...
          },
          {
            id: "v4.11.5",
            code: "4.11.5",
            title: "Use HSMs to Protect Model Weights and Keys",
            description:
      ...
      },
      {
        id: "v4.12",
        code: "C4.12",
        name: "Edge & Distributed AI Infrastructure",
        requirements: [
          {
            id: "v4.12.1",
            code: "4.12.1",
            title: "Authenticate Edge Devices",
            description:
          ...
          },
          {
            id: "v4.12.3",
            code: "4.12.3",
            title: "Use Byzantine Fault-Tolerant Consensus",
            description:
          ...
          },
          {
            id: "v4.12.4",
            code: "4.12.4",
            title: "Secure Edge-to-Cloud Communication",
            description:
      ...
      },
      {
        id: "v4.13",
        code: "C4.13",
        name: "Multi-Cloud & Hybrid Infrastructure Security",
        requirements: [
          {
            id: "v4.13.1",
            code: "4.13.1",
            title: "Use Cloud-Agnostic Identity Federation",
            description:
          ...
          },
          {
            id: "v4.13.2",
            code: "4.13.2",
            title: "Encrypt Cross-Cloud Data Transfer",
            description:
          ...
          },
          {
            id: "v4.13.3",
            code: "4.13.3",
            title: "Implement Consistent Security Policies",
            description:
          ...
          },
          {
            id: "v4.13.4",
            code: "4.13.4",
            title: "Prevent Cloud Vendor Lock-In",
            description:
          ...
          },
          {
            id: "v4.13.5",
            code: "4.13.5",
            title: "Optimize Multi-Cloud Costs Securely",
            description:
              "Verify that multi-cloud cost optimization includes security controls preventing resource sprawl and unauthorized cross-cloud data transfer charges.",
            level: 3,
            category: "v4",
            role: "V",
            references: [
      ...
      },
      {
        id: "v4.14",
        code: "C4.14",
        name: "Infrastructure Automation & GitOps Security",
        requirements: [
          {
            id: "v4.14.1",
            code: "4.14.1",
            title: "Secure GitOps Repositories",
            description:
          ...
          },
          {
            id: "v4.14.2",
            code: "4.14.2",
            title: "Detect and Remediate Drift",
            description:
          ...
          },
          {
            id: "v4.14.3",
            code: "4.14.3",
            title: "Validate Security Policies in Automation",
            description:
          ...
          },
          {
            id: "v4.14.4",
            code: "4.14.4",
            title: "Manage Automation Secrets Securely",
            description:
          ...
          },
          {
            id: "v4.14.5",
            code: "4.14.5",
            title: "Implement Self-Healing Infrastructure",
            description:
      ...
      },
      {
        id: "v4.15",
        code: "C4.15",
        name: "Quantum-Resistant Infrastructure Security",
        requirements: [
          {
            id: "v4.15.1",
            code: "4.15.1",
          ...
          },
          {
            id: "v4.15.2",
            code: "4.15.2",
            title: "Implement Quantum Key Distribution",
            description:
          ...
          },
          {
            id: "v4.15.3",
            code: "4.15.3",
            title: "Use Cryptographic Agility Frameworks",
            description:
          ...
          },
          {
            id: "v4.15.4",
            code: "4.15.4",
            title: "Conduct Quantum Threat Modeling",
            description:
          ...
          },
          {
            id: "v4.15.5",
            code: "4.15.5",
            title: "Use Hybrid Classical-Quantum Cryptography",
            description:
      ...
      },
      {
        id: "v4.16",
        code: "C4.16",
        name: "Confidential Computing & Secure Enclaves",
        requirements: [
          {
            id: "v4.16.1",
            code: "4.16.1",
            title: "Execute Models in Secure Enclaves",
            description:
          ...
          },
          {
            id: "v4.16.2",
            code: "4.16.2",
            title: "Use Confidential Containers",
            description:
          ...
          },
          {
            id: "v4.16.3",
            code: "4.16.3",
            title: "Use Remote Attestation",
            description:
              "Verify that remote attestation validates enclave integrity before loading AI models with cryptographic proof of execution environment authenticity.",
            level: 3,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.16.4",
            code: "4.16.4",
            title: "Prevent Model Extraction with Confidential Inference",
            description:
          ...
          },
          {
            id: "v4.16.5",
            code: "4.16.5",
            title: "Manage Secure Enclave Lifecycle",
            description:
          ...
          },
          {
            id: "v4.16.6",
            code: "4.16.6",
            title: "Use Secure Multi-Party Computation",
            description:
        ...
        requirements: [
          {
            id: "v4.17.1",
            code: "4.17.1",
            title: "Use Zero-Knowledge Proofs for Verification",
            description:
          ...
          },
          {
            id: "v4.17.2",
            code: "4.17.2",
            title: "Use ZK-Based Authentication",
            description:
              "Verify that ZK-based authentication systems enable privacy-preserving user verification for AI services without revealing identity information.",
            level: 3,
            category: "v4",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v4.17.3",
            code: "4.17.3",
            title: "Use Private Set Intersection",
            description:
          ...
          },
          {
            id: "v4.17.4",
            code: "4.17.4",
            title: "Use Zero-Knowledge Machine Learning",
            description:
              "Verify that zero-knowledge machine learning (ZKML) systems enable verifiable AI inference with cryptographic proof of correct computation.",
            level: 3,
            category: "v4",
            role: "D/V",
            references: [
        ...
        requirements: [
          {
            id: "v4.18.1",
            code: "4.18.1",
            title: "Normalize Inference Timing",
            description:
          ...
          },
          {
            id: "v4.18.2",
            code: "4.18.2",
            title: "Protect Against Power Analysis",
            description:
          ...
          },
          {
            id: "v4.18.3",
            code: "4.18.3",
            title: "Mitigate Cache-Based Side-Channels",
            description:
          ...
          },
          {
            id: "v4.18.4",
            code: "4.18.4",
            title: "Protect Against Electromagnetic Emanation",
            description:
          ...
          },
          {
            id: "v4.18.5",
            code: "4.18.5",
            title: "Implement Microarchitectural Side-Channel Defenses",
            description:
      ...
      },
      {
        id: "v4.19",
        code: "C4.19",
        name: "Neuromorphic & Specialized AI Hardware Security",
        requirements: [
          {
            id: "v4.19.1",
            code: "4.19.1",
            title: "Secure Neuromorphic Chips",
            description:
          ...
          },
          {
            id: "v4.19.2",
            code: "4.19.2",
            title: "Secure FPGA-Based AI Accelerators",
            description:
          ...
          },
          {
            id: "v4.19.4",
            code: "4.19.4",
            title: "Secure Optical Computing Systems",
            description:
          ...
          },
          {
            id: "v4.19.5",
            code: "4.19.5",
            title: "Secure Hybrid Analog-Digital AI Chips",
            description:
      ...
      },
      {
        id: "v4.20",
        code: "C4.20",
        name: "Privacy-Preserving Compute Infrastructure",
        requirements: [
          {
            id: "v4.20.1",
            code: "4.20.1",
            title: "Use Homomorphic Encryption",
            description:
          ...
          },
          {
            id: "v4.20.2",
            code: "4.20.2",
            title: "Use Private Information Retrieval",
            description:
          ...
          },
          {
            id: "v4.20.3",
            code: "4.20.3",
            title: "Use Secure Multi-Party Computation Protocols",
            description:
          ...
          },
          {
            id: "v4.20.4",
            code: "4.20.4",
            title: "Use Privacy-Preserving Key Management",
            description:
          ...
          },
          {
            id: "v4.20.5",
            code: "4.20.5",
            title: "Optimize Privacy-Preserving Compute Performance",
            description:
    ...
    references: [
      ...
      {
        title: "ENISA: Secure Infrastructure Design",
        url: "https://www.enisa.europa.eu/topics/critical-information-infrastructures-and-services",
      },
      {
        title: "NIST SP 800-53: Security Controls for Federal Information Systems",
      ...
      {
        title: "IEEE 2857: Privacy Engineering for AI Systems",
      ...
      {
        title: "NIST SP 800-57: Cryptographic Key Management",
        url: "https://csrc.nist.gov/publications/detail/sp/800-57-part-1/rev-5/final",
      },
      {
        title: "Side-Channel Attack Countermeasures",
        url: "https://link.springer.com/book/10.1007/978-3-319-75268-6",
      },
      {
        title: "Neuromorphic Computing Security Challenges",
        url: "https://ieeexplore.ieee.org/document/9458103",
      },
      {
        title: "FPGA Security: Fundamentals, Evaluation, and Countermeasures",
        url: "https://link.springer.com/book/10.1007/978-3-319-90385-9",
      },
      {
      ...
      {
        title: "Private Information Retrieval: Concepts and Constructions",
        url: "https://link.springer.com/book/10.1007/978-3-030-16234-8",
      },
    ],
  },
  v5: {
    ...
    subCategories: [
      {
        id: "v5.1",
        code: "C5.1",
        name: "Identity Management & Authentication",
        requirements: [
          {
            id: "v5.1.1",
            code: "5.1.1",
            title: "Use Centralized Identity Provider",
            description:
            ...
            references: [
              ...
              {
                title: "NIST AI RMF MEASURE 2.6",
                url: "https://airc.nist.gov/AI_RMF_Knowledge_Base/Technical_And_Governance/MEASURE",
              },
            ],
          },
          {
            id: "v5.1.2",
            code: "5.1.2",
            title: "Require MFA for High-Risk Operations",
            description:
          ...
          },
          {
            id: "v5.1.3",
            code: "5.1.3",
            title: "Use Identity Proofing Standards",
            description:
          ...
          },
          {
            id: "v5.1.5",
            code: "5.1.5",
            title: "Use Signed JWTs for Federated Agents",
            description:
      ...
      },
      {
        id: "v5.2",
        code: "C5.2",
        name: "Resource Authorization & Least Privilege",
        requirements: [
          {
            id: "v5.2.1",
            code: "5.2.1",
          ...
          },
          {
            id: "v5.2.2",
            code: "5.2.2",
            title: "Enforce Least-Privilege by Default",
            description:
          ...
          },
          {
            id: "v5.2.3",
            code: "5.2.3",
            title: "Log Access Control Modifications",
            description:
      ...
      },
      {
        id: "v5.3",
        code: "C5.3",
        name: "Dynamic Policy Evaluation",
        requirements: [
          {
            id: "v5.3.1",
            code: "5.3.1",
            title: "Externalize Authorization Decisions",
            description:
          ...
          },
          {
            id: "v5.3.2",
            code: "5.3.2",
            title: "Evaluate Dynamic Attributes",
            description:
          ...
          },
          {
            id: "v5.3.3",
            code: "5.3.3",
            title: "Version-Control and Test Policies",
            description:
          ...
          },
          {
            id: "v5.3.4",
            code: "5.3.4",
            title: "Log Policy Evaluation Results",
            description:
      ...
      },
      {
        id: "v5.4",
        code: "C5.4",
        name: "Query-Time Security Enforcement",
        requirements: [
          {
            id: "v5.4.1",
            code: "5.4.1",
            title: "Enforce Mandatory Security Filters",
            description:
          ...
          },
          {
            id: "v5.4.3",
            code: "5.4.3",
            title: "Abort Queries on Failed Authorization",
            description:
          ...
          },
          {
            id: "v5.4.4",
            code: "5.4.4",
            title: "Monitor Policy Evaluation Latency",
            description:
          ...
          },
          {
            id: "v5.4.5",
            code: "5.4.5",
            title: "Re-evaluate Authorization on Retries",
            description:
      ...
      },
      {
        id: "v5.5",
        code: "C5.5",
        name: "Output Filtering & Data Loss Prevention",
        requirements: [
          {
            id: "v5.5.1",
            code: "5.5.1",
            title: "Scan and Redact Unauthorized Data",
            description:
          ...
          },
          {
            id: "v5.5.2",
            code: "5.5.2",
            title: "Validate Citations and References",
            description:
          ...
          },
          {
            id: "v5.5.3",
            code: "5.5.3",
            title: "Enforce Output Format Restrictions",
            description:
          ...
          },
          {
            id: "v5.5.4",
            code: "5.5.4",
            title: "Maintain Audit Logs for Redaction",
            description:
          ...
          },
          {
            id: "v5.5.5",
            code: "5.5.5",
            title: "Generate Adaptive Logs for High-Risk Events",
            description:
        ...
        requirements: [
          {
            id: "v5.6.1",
            code: "5.6.1",
            title: "Segregate Tenant Resources",
            description:
          ...
          },
          {
            id: "v5.6.2",
            code: "5.6.2",
            title: "Validate Tenant Identifier in API Requests",
            description:
          ...
          },
          {
            id: "v5.6.4",
            code: "5.6.4",
            title: "Use Unique Encryption Keys per Tenant",
            description:
      ...
      },
      {
        id: "v5.7",
        code: "C5.7",
        name: "Autonomous Agent Authorization",
        requirements: [
          {
            id: "v5.7.1",
            code: "5.7.1",
            title: "Use Scoped Capability Tokens",
            description:
          ...
          },
          {
            id: "v5.7.2",
            code: "5.7.2",
            title: "Disable High-Risk Capabilities by Default",
            description:
          ...
          },
          {
            id: "v5.7.3",
            code: "5.7.3",
            title: "Bind Capability Tokens to User Sessions",
            description:
          ...
          },
          {
            id: "v5.7.4",
            code: "5.7.4",
            title: "Use Secondary Authorization for Agent Actions",
            description:
          ...
          },
          {
            id: "v5.7.5",
            code: "5.7.5",
            title: "Include Capability Scope in Error Conditions",
            description:
    ...
    references: [
      ...
      {
        title: "OWASP Application Security Verification Standard (AISVS)",
        url: "https://owasp.org/www-project-application-security-verification-standard/",
      },
      {
        title: "Identity and Access Management in the AI Era: 2025 Guide – IDSA",
        url: "https://www.idsalliance.org/blog/identity-and-access-management-in-the-ai-era-2025-guide/",
      },
      {
        title: "Attribute-Based Access Control with OPA – Permify",
      ...
      {
        title: "How We Designed Cedar to Be Intuitive, Fast, and Safe – AWS",
        url: "https://aws.amazon.com/blogs/security/how-we-designed-cedar-to-be-intuitive-to-use-fast-and-safe/",
      },
      {
        title: "Row Level Security in Vector DBs for RAG – Bluetuple.ai",
        url: "https://medium.com/bluetuple-ai/implementing-row-level-security-in-vector-dbs-for-rag-applications-fdbccb63d464",
      },
      {
        title: "Tenant Isolation in Multi-Tenant Systems – WorkOS",
        url: "https://workos.com/blog/tenant-isolation-in-multi-tenant-systems",
      },
      {
        title: "Handling AI Agent Permissions – Stytch",
        url: "https://stytch.com/blog/handling-ai-agent-permissions/",
      },
      {
  ...
  v6: {
    ...
    subCategories: [
      {
        id: "v6.1",
        code: "C6.1",
        name: "Pretrained Model Vetting & Provenance",
        requirements: [
          {
            id: "v6.1.1",
            code: "6.1.1",
            title: "Require Signed Provenance Records",
            description:
          ...
          },
          {
            id: "v6.1.2",
            code: "6.1.2",
            title: "Scan Models for Malicious Layers",
            description:
          ...
          },
          {
            id: "v6.1.3",
            code: "6.1.3",
            title: "Adversarially Evaluate Fine-Tunes",
            description:
          ...
          },
          {
            id: "v6.1.4",
            code: "6.1.4",
            title: "Record Licenses in ML-BOM",
            description:
          ...
          },
          {
            id: "v6.1.5",
            code: "6.1.5",
            title: "Quarantine High-Risk Models",
            description:
      ...
      },
      {
        id: "v6.2",
        code: "C6.2",
        name: "Framework & Library Scanning",
        requirements: [
          {
            id: "v6.2.1",
            code: "6.2.1",
            title: "Run Dependency Scanners in CI",
            description:
          ...
          },
          {
            id: "v6.2.2",
            code: "6.2.2",
            title: "Block Promotion on Critical Vulnerabilities",
            description:
          ...
          },
          {
            id: "v6.2.4",
            code: "6.2.4",
            title: "Include Security Impact Assessment for Upgrades",
            description:
          ...
          },
          {
            id: "v6.2.5",
            code: "6.2.5",
            title: "Alert on Unexpected Library Loads",
            description:
      ...
      },
      {
        id: "v6.3",
        code: "C6.3",
        name: "Dependency Pinning & Verification",
        requirements: [
          {
            id: "v6.3.1",
            code: "6.3.1",
            title: "Enforce Version Pinning",
            description: "Verify that all package managers enforce version pinning via lockfiles.",
            level: 1,
            category: "v6",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v6.3.3",
            code: "6.3.3",
            title: "Use Reproducible-Build Checks",
            description:
          ...
          },
          {
            id: "v6.3.4",
            code: "6.3.4",
            title: "Store Build Attestations",
            description:
      ...
      },
      {
        id: "v6.4",
        code: "C6.4",
        name: "Trusted Source Enforcement",
        requirements: [
          {
            id: "v6.4.1",
            code: "6.4.1",
            title: "Download from Approved Sources",
            description:
          ...
          },
          {
            id: "v6.4.2",
            code: "6.4.2",
            title: "Validate Publisher Identity",
            description:
          ...
          },
          {
            id: "v6.4.3",
            code: "6.4.3",
            title: "Block Unauthenticated Downloads",
            description:
          ...
          },
          {
            id: "v6.4.4",
            code: "6.4.4",
            title: "Review Allow-Lists Quarterly",
            description:
          ...
          },
          {
            id: "v6.4.5",
            code: "6.4.5",
            title: "Quarantine Artifacts on Policy Violations",
            description:
      ...
      },
      {
        id: "v6.5",
        code: "C6.5",
        name: "Third‑Party Dataset Risk Assessment",
        requirements: [
          {
            id: "v6.5.1",
            code: "6.5.1",
            title: "Assess Poisoning Risk",
            description:
          ...
          },
          {
            id: "v6.5.3",
            code: "6.5.3",
            title: "Capture Provenance in ML-BOM",
            description:
          ...
          },
          {
            id: "v6.5.5",
            code: "6.5.5",
            title: "Remove Disallowed Content",
            description:
      ...
      },
      {
        id: "v6.6",
        code: "C6.6",
        name: "Supply Chain Attack Monitoring",
        requirements: [
          {
            id: "v6.6.1",
            code: "6.6.1",
            title: "Stream Audit Logs to SIEM",
            description:
          ...
          },
          {
            id: "v6.6.2",
            code: "6.6.2",
            title: "Include Rollback Procedures in Playbooks",
            description:
          ...
          },
          {
            id: "v6.6.3",
            code: "6.6.3",
            title: "Use Threat-Intel Enrichment",
            description:
      ...
      },
      {
        id: "v6.7",
        code: "C6.7",
        name: "ML‑BOM for Model Artifacts",
        requirements: [
          {
            id: "v6.7.1",
            code: "6.7.1",
            title: "Publish ML-BOM for Every Artifact",
            description:
          ...
          },
          {
            id: "v6.7.2",
            code: "6.7.2",
            title: "Automate ML-BOM Generation",
            description:
          ...
          },
          {
            id: "v6.7.3",
            code: "6.7.3",
            title: "Implement ML-BOM Completeness Checks",
            description:
    ...
    references: [
      {
        title: "ML Supply Chain Compromise – MITRE ATLAS",
        url: "https://misp-galaxy.org/mitre-atlas-attack-pattern/",
      },
      ...
      {
        title: "What is Data Poisoning? – SentinelOne",
        url: "https://www.sentinelone.com/cybersecurity-101/cybersecurity/data-poisoning/",
      },
      {
        title: "Transfer Learning Attack – OWASP ML Security Top 10",
        url: "https://owasp.org/www-project-machine-learning-security-top-10/docs/ML07_2023-Transfer_Learning_Attack",
      },
      {
        title: "AI Data Security Best Practices – CISA",
        url: "https://www.cisa.gov/news-events/cybersecurity-advisories/aa25-142a",
      },
      {
        title: "Secure CI/CD Supply Chain – Sumo Logic",
        url: "https://www.sumologic.com/blog/secure-azure-devops-github-supply-chain-attacks",
      },
      {
        title: "AI & Transparency: Protect ML Models – ReversingLabs",
        url: "https://www.reversinglabs.com/blog/ai-and-transparency-how-ml-model-creators-can-protect-against-supply-chain-attacks",
      },
      ...
      {
        title: "Dependency Pinning for Reproducible Python – Medium",
        url: "https://medium.com/data-science-collective/guarantee-a-locked-reproducible-environment-with-every-python-run-c0e2bf19fb53",
      },
    ],
  },
  v7: {
    ...
    subCategories: [
        ...
        requirements: [
          {
            ...
            references: [
              ...
              { title: "ISO/IEC 27001:2022 A.8.24", url: "https://www.iso.org/standard/27001" },
            ],
          },
          {
            id: "v7.1.2",
            code: "7.1.2",
            title: "Enable Constrained Decoding",
            description:
          ...
          },
          {
            id: "v7.1.3",
            code: "7.1.3",
            title: "Treat Outputs as Untrusted",
            description:
          ...
          },
          {
            id: "v7.1.4",
            code: "7.1.4",
            title: "Log Improper-Output Events",
            description:
        ...
        requirements: [
          {
            id: "v7.2.1",
            code: "7.2.1",
            title: "Assign Confidence Scores",
            description:
          ...
          },
          {
            id: "v7.2.2",
            code: "7.2.2",
            title: "Trigger Fallback Workflows",
            description:
          ...
          },
          {
            id: "v7.2.3",
            code: "7.2.3",
            title: "Tag Hallucination Incidents",
            description:
          ...
          },
          {
            id: "v7.2.4",
            code: "7.2.4",
            title: "Recalibrate Thresholds and Detectors",
            description:
          ...
          },
          {
            id: "v7.2.5",
            code: "7.2.5",
            title: "Track Hallucination Rates",
            description: "Verify that dashboard visualisations track hallucination rates.",
            level: 3,
            category: "v7",
            role: "V",
            references: [
      ...
      },
      {
        id: "v7.3",
        code: "C7.3",
        name: "Output Safety & Privacy Filtering",
        requirements: [
          {
            id: "v7.3.1",
            code: "7.3.1",
          ...
          },
          {
            id: "v7.3.2",
            code: "7.3.2",
            title: "Detect and Redact PII/PCI",
            description:
          ...
          },
          {
            id: "v7.3.3",
            code: "7.3.3",
            title: "Propagate Confidentiality Tags",
            description:
          ...
          },
          {
            id: "v7.3.4",
            code: "7.3.4",
            title: "Require Secondary Approval for High-Risk Classifications",
            description:
          ...
          },
          {
            id: "v7.3.5",
            code: "7.3.5",
            title: "Reflect Legal Jurisdictions in Filtering",
            description:
      ...
      },
      {
        id: "v7.4",
        code: "C7.4",
        name: "Output & Action Limiting",
        requirements: [
          {
            id: "v7.4.1",
            code: "7.4.1",
            title: "Limit Requests, Tokens, and Cost",
            description:
          ...
          },
          {
            id: "v7.4.2",
            code: "7.4.2",
            title: "Require Approval for Privileged Actions",
            description:
          ...
          },
          {
            id: "v7.4.3",
            code: "7.4.3",
            title: "Use Cross-Modal Consistency Checks",
            description:
          ...
          },
          {
            id: "v7.4.4",
            code: "7.4.4",
            title: "Configure Agent Delegation Depth",
            description:
          ...
          },
          {
            id: "v7.4.5",
            code: "7.4.5",
            title: "Emit Structured Security Events",
            description:
      ...
      },
      {
        id: "v7.5",
        code: "C7.5",
        name: "Output Explainability",
        requirements: [
          {
            id: "v7.5.1",
            code: "7.5.1",
            title: "Expose User-Facing Confidence Scores",
            description:
          ...
          },
          {
            id: "v7.5.2",
            code: "7.5.2",
            title: "Avoid Revealing Sensitive Data in Explanations",
            description:
          ...
          },
          {
            id: "v7.5.3",
            code: "7.5.3",
            title: "Capture and Store Token-Level Probabilities",
            description:
          ...
          },
          {
            id: "v7.5.4",
            code: "7.5.4",
            title: "Version Control Explainability Artefacts",
            description:
        ...
        requirements: [
          {
            id: "v7.6.1",
            code: "7.6.1",
            title: "Stream Metrics to Monitoring Platform",
            description:
          ...
          },
          {
            id: "v7.6.3",
            code: "7.6.3",
            title: "Correlate Anomalies with Changes",
            description:
          ...
          },
          {
            id: "v7.6.4",
            code: "7.6.4",
            title: "Feed Monitoring Data into MLOps",
            description:
          ...
          },
          {
            id: "v7.6.5",
            code: "7.6.5",
            title: "Penetration Test Monitoring Pipelines",
            description:
      ...
      },
      {
        id: "v7.7",
        code: "C7.7",
        name: "Generative Media Safeguards",
        requirements: [
          {
            id: "v7.7.1",
            code: "7.7.1",
            title: "Prohibit Generation of Illegal Media",
            description:
          ...
          },
          {
            id: "v7.7.2",
            code: "7.7.2",
            title: "Filter Prompts for Impersonations",
            description:
          ...
          },
          {
            id: "v7.7.3",
            code: "7.7.3",
            title: "Prevent Reproduction of Copyrighted Media",
            description:
          ...
          },
          {
            id: "v7.7.4",
            code: "7.7.4",
            title: "Embed Provenance Metadata in Generated Media",
            description:
          ...
          },
          {
            id: "v7.7.5",
            code: "7.7.5",
            title: "Detect and Log Bypass Attempts",
            description:
    ...
    references: [
      ...
      {
        title: "Improper Output Handling – OWASP LLM05:2025",
        url: "https://genai.owasp.org/llmrisk/llm052025-improper-output-handling/",
      },
      {
        title: "Practical Techniques to Constrain LLM Output",
        url: "https://mychen76.medium.com/practical-techniques-to-constraint-llm-output-in-json-format-e3e72396c670",
      },
      {
        title: "Dataiku – Structured Text Generation Guide",
        url: "https://blog.dataiku.com/your-guide-to-structured-text-generation",
      },
      {
        title: "VL-Uncertainty: Detecting Hallucinations",
        url: "https://arxiv.org/abs/2411.11919",
      },
      {
        title: "HaDeMiF: Hallucination Detection & Mitigation",
        url: "https://openreview.net/forum?id=VwOYxPScxB",
      },
      {
        title: "Building Confidence in LLM Outputs",
        url: "https://www.alkymi.io/data-science-room/building-confidence-in-llm-outputs",
      },
      {
        title: "Explainable AI & LLMs",
        url: "https://duncsand.medium.com/explainable-ai-140912d31b3b",
      },
      {
      ...
      {
        title: "Sensitive Information Disclosure in LLMs",
        url: "https://virtualcyberlabs.com/llm-sensitive-information-disclosure/",
      },
      {
        title: "LangChain – Chat Model Rate Limiting",
        url: "https://python.langchain.com/docs/how_to/chat_model_rate_limiting/",
      },
      {
        title: "OpenAI Rate-Limit & Exponential Back-off",
        url: "https://hackernoon.com/openais-rate-limit-a-guide-to-exponential-backoff-for-llm-evaluation",
      },
  ...
  v8: {
    ...
    subCategories: [
      {
        id: "v8.1",
        code: "C8.1",
        name: "Access Controls on Memory & RAG Indices",
        requirements: [
          {
            id: "v8.1.1",
            code: "8.1.1",
            title: "Use Row/Namespace-Level Access Control",
            description:
          ...
          },
          {
            id: "v8.1.2",
            code: "8.1.2",
            title: "Use Scoped API Keys/JWTs",
            description:
          ...
          },
          {
            id: "v8.1.3",
            code: "8.1.3",
            title: "Detect and Log Privilege-Escalation Attempts",
            description:
          ...
          },
          {
            id: "v8.1.5",
            code: "8.1.5",
            title: "Test for Access Control Bypass Flaws",
            description:
      ...
      },
      {
        id: "v8.2",
        code: "C8.2",
        name: "Embedding Sanitization & Validation",
        requirements: [
          {
            id: "v8.2.1",
            code: "8.2.1",
            title: "Detect and Mask PII",
            description:
          ...
          },
          {
            id: "v8.2.4",
            code: "8.2.4",
            title: "Validate Sanitization Efficacy",
            description:
          ...
          },
          {
            id: "v8.2.5",
            code: "8.2.5",
            title: "Version-Control Sanitization Configs",
            description:
      ...
      },
      {
        id: "v8.3",
        code: "C8.3",
        name: "Memory Expiry, Revocation & Deletion",
        requirements: [
          {
            id: "v8.3.1",
            code: "8.3.1",
            title: "Use TTLs for Vectors",
            description:
          ...
          },
          {
            id: "v8.3.2",
            code: "8.3.2",
            title: "Purge Data on Deletion Requests",
            description:
          ...
          },
          {
            id: "v8.3.3",
            code: "8.3.3",
            title: "Use Cryptographic Shredding",
            description:
          ...
          },
          {
            id: "v8.3.4",
            code: "8.3.4",
            title: "Exclude Expired Vectors from Search",
            description:
      ...
      },
      {
        id: "v8.4",
        code: "C8.4",
        name: "Prevent Embedding Inversion & Leakage",
        requirements: [
          {
            id: "v8.4.1",
            code: "8.4.1",
            title: "Maintain a Formal Threat Model",
            description:
          ...
          },
          {
            id: "v8.4.2",
            code: "8.4.2",
            title: "Use Application-Layer Encryption",
            description:
          ...
          },
          {
            id: "v8.4.3",
            code: "8.4.3",
            title: "Balance Privacy and Utility",
            description:
          ...
          },
          {
            id: "v8.4.4",
            code: "8.4.4",
            title: "Include Inversion-Resilience in Release Gates",
            description:
      ...
      },
      {
        id: "v8.5",
        code: "C8.5",
        name: "Scope Enforcement for User-Specific Memory",
        requirements: [
          {
            id: "v8.5.1",
            code: "8.5.1",
            title: "Post-Filter Retrieval Queries",
            description:
          ...
          },
          {
            id: "v8.5.3",
            code: "8.5.3",
            title: "Discard Out-of-Scope Similarity Results",
            description:
          ...
          },
          {
            id: "v8.5.4",
            code: "8.5.4",
            title: "Use Multi-Tenant Stress Tests",
            description:
          ...
          },
          {
            id: "v8.5.5",
            code: "8.5.5",
            title: "Segregate Encryption Keys per Tenant",
            description:
      ...
      },
      {
        id: "v8.6",
        code: "C8.6",
        name: "Advanced Memory System Security",
        requirements: [
          {
            id: "v8.6.1",
            code: "8.6.1",
            title: "Isolate Memory Types",
            description:
          ...
          },
          {
            id: "v8.6.2",
            code: "8.6.2",
            title: "Validate Memory Consolidation Processes",
            description:
          ...
          },
          {
            id: "v8.6.3",
            code: "8.6.3",
            title: "Validate and Sanitize Memory Retrieval Queries",
            description:
          ...
          },
          {
            id: "v8.6.4",
            code: "8.6.4",
            title: "Securely Delete Sensitive Information",
            description:
          ...
          },
          {
            id: "v8.6.5",
            code: "8.6.5",
            title: "Monitor Memory System Integrity",
            description:
    ...
    references: [
      {
        title: "Vector database security: Pinecone – IronCore Labs",
        url: "https://ironcorelabs.com/vectordbs/pinecone-security/",
      },
      {
        title:
          "Securing the Backbone of AI: Safeguarding Vector Databases and Embeddings – Privacera",
        url: "https://privacera.com/blog/securing-the-backbone-of-ai-safeguarding-vector-databases-and-embeddings/",
      },
      {
        title: "Enhancing Data Security with RBAC of Qdrant Vector Database – AI Advances",
        url: "https://ai.gopubby.com/enhancing-data-security-with-role-based-access-control-of-qdrant-vector-database-3878769bec83",
      },
      {
        title: "Mitigating Privacy Risks in LLM Embeddings from Embedding Inversion – arXiv",
        url: "https://arxiv.org/html/2411.05034v1",
      },
      {
        title: "DPPN: Detecting and Perturbing Privacy-Sensitive Neurons – OpenReview",
        url: "https://openreview.net/forum?id=DF5TVzpTW0",
      },
      { title: "Art. 17 GDPR – Right to Erasure", url: "https://gdpr-info.eu/art-17-gdpr/" },
      {
        title: "Sensitive Data in Text Embeddings Is Recoverable – Tonic.ai",
        url: "https://www.tonic.ai/blog/sensitive-data-in-text-embeddings-is-recoverable",
      },
      {
        title: "PII Identification and Removal – NVIDIA NeMo Docs",
        url: "https://docs.nvidia.com/nemo-framework/user-guide/latest/datacuration/personalidentifiableinformationidentificationandremoval.html",
      },
      {
        title: "De-identifying Sensitive Data – Google Cloud DLP",
      ...
      {
        title: "Think Your RAG Is Secure? Think Again – Medium",
        url: "https://medium.com/%40vijay.poudel1/think-your-rag-is-secure-think-again-heres-how-to-actually-lock-it-down-c4c30e3864e7",
      },
      {
        title: "Design a Secure Multitenant RAG Inferencing Solution – Microsoft Learn",
        url: "https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/secure-multitenant-rag",
      },
      {
        title: "Best Practices for Multi-Tenancy RAG with Milvus – Milvus Blog",
        url: "https://milvus.io/blog/build-multi-tenancy-rag-with-milvus-best-practices-part-one.md",
      },
    ],
  },
  v9: {
    ...
    subCategories: [
      {
        id: "v9.1",
        code: "C9.1",
        name: "Agent Task-Planning & Recursion Budgets",
        requirements: [
          {
            id: "v9.1.1",
            code: "9.1.1",
            title: "Centrally Configure and Version-Control Budgets",
            description:
          ...
          },
          {
            id: "v9.1.2",
            code: "9.1.2",
            title: "Require Human Approval for Privileged Actions",
            description:
          ...
          },
          {
            id: "v9.1.3",
            code: "9.1.3",
            title: "Trigger Circuit-Breaker on Exceeded Thresholds",
            description:
          ...
          },
          {
            id: "v9.1.4",
            code: "9.1.4",
            title: "Log Circuit-Breaker Events for Forensic Review",
            description:
          ...
          },
          {
            id: "v9.1.5",
            code: "9.1.5",
            title: "Test for Budget Exhaustion and Runaway Scenarios",
            description:
          ...
          },
          {
            id: "v9.1.6",
            code: "9.1.6",
            title: "Express Budget Policies as Policy-as-Code",
            description:
      ...
      },
      {
        id: "v9.2",
        code: "C9.2",
        name: "Tool Plugin Sandboxing",
        requirements: [
          {
            id: "v9.2.1",
            code: "9.2.1",
            title: "Execute Tools in Least-Privilege Sandboxes",
            description:
          ...
          },
          {
            id: "v9.2.2",
            code: "9.2.2",
            title: "Enforce and Log Sandbox Resource Quotas",
            description:
          ...
          },
          {
            id: "v9.2.3",
            code: "9.2.3",
            title: "Validate Tool Signatures Before Loading",
            description:
          ...
          },
          {
            id: "v9.2.4",
            code: "9.2.4",
            title: "Stream Sandbox Telemetry to SIEM for Alerting",
            description:
          ...
          },
          {
            id: "v9.2.5",
            code: "9.2.5",
            title: "Conduct Security Reviews for High-Risk Plugins",
            description:
          ...
          },
          {
            id: "v9.2.6",
            code: "9.2.6",
            title: "Automatically Block and Quarantine on Escape Attempts",
            description:
      ...
      },
      {
        id: "v9.3",
        code: "C9.3",
        name: "Autonomous Loop & Cost Bounding",
        requirements: [
          {
            id: "v9.3.1",
            code: "9.3.1",
            title: "Enforce Hop-Limits or TTL in Inter-Agent Calls",
            description:
          ...
          },
          {
            id: "v9.3.2",
            code: "9.3.2",
            title: "Use Unique Invocation-Graph IDs to Detect Cycles",
            description:
          ...
          },
          {
            id: "v9.3.3",
            code: "9.3.3",
            title: "Track Cumulative Counters and Abort on Breach",
            description:
          ...
          },
          {
            id: "v9.3.4",
            code: "9.3.4",
            title: "Formally Analyze for Unbounded Recursion",
            description:
          ...
          },
          {
            id: "v9.3.5",
            code: "9.3.5",
            title: "Generate Alerts from Loop-Abort Events",
            description:
      ...
      },
      {
        id: "v9.4",
        code: "C9.4",
        name: "Protocol-Level Misuse Protection",
        requirements: [
          {
            id: "v9.4.1",
            code: "9.4.1",
            title: "Authenticate and Encrypt All Agent Communications",
            description:
          ...
          },
          {
            id: "v9.4.2",
            code: "9.4.2",
            title: "Strictly Validate Schemas and Reject Malformed Messages",
            description:
          ...
          },
          {
            id: "v9.4.3",
            code: "9.4.3",
            title: "Use Integrity Checks for Message Payloads",
            description:
          ...
          },
          {
            id: "v9.4.4",
            code: "9.4.4",
            title: "Enforce Replay Protection",
            description:
          ...
          },
          {
            id: "v9.4.5",
            code: "9.4.5",
            title: "Test Protocol Implementations for Flaws",
            description:
      ...
      },
      {
        id: "v9.5",
        code: "C9.5",
        name: "Agent Identity & Tamper-Evidence",
        requirements: [
          {
            id: "v9.5.1",
            code: "9.5.1",
            title: "Assign Unique Cryptographic Identities to Agents",
            description:
          ...
          },
          {
            id: "v9.5.2",
            code: "9.5.2",
            title: "Sign and Timestamp All Agent Actions",
            description:
          ...
          },
          {
            id: "v9.5.3",
            code: "9.5.3",
            title: "Store Logs in a Tamper-Evident Medium",
            description:
          ...
          },
          {
            id: "v9.5.4",
            code: "9.5.4",
            title: "Rotate Identity Keys on a Defined Schedule",
            description:
          ...
          },
          {
            id: "v9.5.5",
            code: "9.5.5",
            title: "Quarantine Agents on Spoofing or Key-Conflict Attempts",
            description:
      ...
      },
      {
        id: "v9.6",
        code: "C9.6",
        name: "Multi-Agent Swarm Risk Reduction",
        requirements: [
          {
            id: "v9.6.1",
            code: "9.6.1",
            title: "Isolate Agents in Different Security Domains",
            description:
          ...
          },
          {
            id: "v9.6.2",
            code: "9.6.2",
            title: "Formally Verify Swarm Behaviors for Safety",
            description:
          ...
          },
          {
            id: "v9.6.3",
            code: "9.6.3",
            title: "Monitor Runtimes for Emergent Unsafe Patterns",
            description:
      ...
      },
      {
        id: "v9.7",
        code: "C9.7",
        name: "User & Tool Authentication / Authorization",
        requirements: [
          {
            id: "v9.7.1",
            code: "9.7.1",
            title: "Authenticate Agents as First-Class Principals",
            description:
          ...
          },
          {
            id: "v9.7.2",
            code: "9.7.2",
            title: "Implement Fine-Grained Authorization Policies",
            description:
          ...
          },
          {
            id: "v9.7.3",
            code: "9.7.3",
            title: "Re-evaluate Privileges on Every Call (Continuous Authorization)",
            description:
          ...
          },
          {
            id: "v9.7.4",
            code: "9.7.4",
            title: "Automatically Expire Delegated Privileges",
            description:
      ...
      },
      {
        id: "v9.8",
        code: "C9.8",
        name: "Agent-to-Agent Communication Security",
        requirements: [
          {
            id: "v9.8.1",
            code: "9.8.1",
            title: "Mandate Mutual Authentication and Encryption for Agent Channels",
            description:
          ...
          },
          {
            id: "v9.8.2",
            code: "9.8.2",
            title: "Validate Message Integrity and Origin",
            description:
          ...
          },
          {
            id: "v9.8.3",
            code: "9.8.3",
            title: "Log Communication Metadata for Forensics",
            description:
          ...
          },
          {
            id: "v9.8.4",
            code: "9.8.4",
            title: "Formally Verify Protocol State Machines",
            description:
      ...
      },
      {
        id: "v9.9",
        code: "C9.9",
        name: "Intent Verification & Constraint Enforcement",
        requirements: [
          {
            id: "v9.9.1",
            code: "9.9.1",
            title: "Use Pre-Execution Constraint Solvers",
            description:
          ...
          },
          {
            id: "v9.9.2",
            code: "9.9.2",
            title: "Require User Confirmation for High-Impact Actions",
            description:
          ...
          },
          {
            id: "v9.9.3",
            code: "9.9.3",
            title: "Use Post-Condition Checks to Validate Effects",
            description:
          ...
          },
          {
            id: "v9.9.4",
            code: "9.9.4",
            title: "Use Formal Methods to Demonstrate Constraint Satisfaction",
            description:
          ...
          },
          {
            id: "v9.9.5",
            code: "9.9.5",
            title: "Use Incidents to Feed Improvement Cycles",
            description:
      ...
      },
      {
        id: "v9.10",
        code: "C9.10",
        name: "Agent Reasoning Strategy Security",
        requirements: [
          {
            id: "v9.10.1",
            code: "9.10.1",
            title: "Use Deterministic Criteria for Strategy Selection",
            description:
          ...
          },
          {
            id: "v9.10.2",
            code: "9.10.2",
            title: "Implement Dedicated Security Controls for Each Strategy",
            description:
          ...
          },
          {
            id: "v9.10.3",
            code: "9.10.3",
            title: "Log Reasoning Strategy Transitions with Full Context",
            description:
          ...
          },
          {
            id: "v9.10.4",
            code: "9.10.4",
            title: "Implement Branch Pruning in Tree-of-Thoughts Reasoning",
            description:
          ...
          },
          {
            id: "v9.10.5",
            code: "9.10.5",
            title: "Include Validation Checkpoints in ReAct Cycles",
            description:
          ...
          },
          {
            id: "v9.10.6",
            code: "9.10.6",
            title: "Monitor Reasoning Strategy Performance Metrics",
            description:
          ...
          },
          {
            id: "v9.10.7",
            code: "9.10.7",
            title: "Maintain Security Controls in Hybrid Reasoning Approaches",
            description:
          ...
          },
          {
            id: "v9.10.8",
            code: "9.10.8",
            title: "Conduct Security Testing for Reasoning Strategies",
            description:
      ...
      },
      {
        id: "v9.11",
        code: "C9.11",
        name: "Agent Lifecycle State Management & Security",
        requirements: [
          {
            id: "v9.11.1",
            code: "9.11.1",
            title: "Establish Cryptographic Identity and Immutable Logs at Initialization",
            description:
          ...
          },
          {
            id: "v9.11.2",
            code: "9.11.2",
            title: "Cryptographically Sign and Log State Transitions",
            description:
          ...
          },
          {
            id: "v9.11.3",
            code: "9.11.3",
            title: "Implement Secure Shutdown Procedures",
            description:
          ...
          },
          {
            id: "v9.11.4",
            code: "9.11.4",
            title: "Implement Secure Agent Recovery Mechanisms",
            description:
          ...
          },
          {
            id: "v9.11.5",
            code: "9.11.5",
            title: "Encrypt Sensitive State Data with Secure Key Rotation",
            description:
      ...
      },
      {
        id: "v9.12",
        code: "C9.12",
        name: "Tool Integration Security Framework",
        requirements: [
          {
            id: "v9.12.1",
            code: "9.12.1",
            title: "Include Security Metadata in Tool Descriptors",
            description:
          ...
          },
          {
            id: "v9.12.2",
            code: "9.12.2",
            title: "Validate Tool Execution Results Against Schemas and Policies",
            description:
          ...
          },
          {
            id: "v9.12.3",
            code: "9.12.3",
            title: "Log Tool Interactions with Detailed Security Context",
            description:
          ...
          },
          {
            id: "v9.12.4",
            code: "9.12.4",
            title: "Validate Signatures and Isolate Dynamic Tool Loading",
            description:
          ...
          },
          {
            id: "v9.12.5",
            code: "9.12.5",
            title: "Automate Tool Security Assessments with Mandatory Approval Gates",
            description:
    ...
    references: [
      ...
      {
        title: "Circuit-breaker research for AI agents — Zou et al., 2024",
        url: "https://arxiv.org/abs/2406.04313",
      },
      {
        title: "Trend Micro analysis of sandbox escapes in AI agents — Park, 2025",
      ...
      {
        title: "Auth0 guidance on human-in-the-loop authorization for agents — Martinez, 2025",
        url: "https://auth0.com/blog/secure-human-in-the-loop-interactions-for-ai-agents/",
      },
      {
        title: "Medium deep-dive on MCP & A2A protocol hijacking — ForAISec, 2025",
        url: "https://medium.com/%40foraisec/security-analysis-potential-ai-agent-hijacking-via-mcp-and-a2a-protocol-insights-cd1ec5e6045f",
      },
      {
        title: "Rapid7 fundamentals on spoofing attack prevention — 2024",
        url: "https://www.rapid7.com/fundamentals/spoofing-attacks/",
      },
      {
        title: "Imperial College verification of swarm systems — Lomuscio et al.",
        url: "https://sail.doc.ic.ac.uk/projects/swarms/",
      },
      {
      ...
      {
        title: "WIRED security briefing on encryption best practices, 2024",
        url: "https://www.wired.com/story/encryption-apps-chinese-telecom-hacking-hydra-russia-exxon",
      },
      {
  ...
  v10: {
    ...
    subCategories: [
      {
        id: "v10.1",
        code: "C10.1",
        name: "Model Alignment & Safety",
        requirements: [
          {
            id: "v10.1.1",
            code: "10.1.1",
            title: "Maintain and Run an Alignment Test Suite",
            description:
            ...
            references: [
              {
                title: "NIST AI RMF GOVERN 1.1",
                url: "https://airc.nist.gov/AI_RMF_Knowledge_Base/Technical_And_Governance/GOVERN",
              },
              { title: "ISO/IEC 42001:2023 A.6.2", url: "https://www.iso.org/standard/81230.html" },
            ],
          },
          {
            id: "v10.1.2",
            code: "10.1.2",
            title: "Enforce Refusal and Safe-Completion Guard-rails",
            description: "Verify that refusal and safe-completion guard-rails are enforced.",
            level: 1,
            category: "v10",
            role: "D",
            references: [
          ...
          },
          {
            id: "v10.1.3",
            code: "10.1.3",
            title: "Automatically Evaluate and Flag Regressions in Harmful Content Rate",
            description:
          ...
          },
          {
            id: "v10.1.4",
            code: "10.1.4",
            title: "Document and Ensure Reproducibility of Counter-Jailbreak Training",
            description: "Verify that counter-jailbreak training is documented and reproducible.",
            level: 2,
            category: "v10",
            role: "D",
            references: [
          ...
          },
          {
            id: "v10.1.5",
            code: "10.1.5",
            title: "Use Formal Proofs for Policy Compliance in Critical Domains",
            description:
      ...
      },
      {
        id: "v10.2",
        code: "C10.2",
        name: "Adversarial-Example Hardening",
        requirements: [
          {
            id: "v10.2.1",
            code: "10.2.1",
            title: "Include Reproducible Adversarial-Training Configurations",
            description:
          ...
          },
          {
            id: "v10.2.2",
            code: "10.2.2",
            title: "Raise Blocking Alerts for Adversarial-Example Detection",
            description:
          ...
          },
          {
            id: "v10.2.4",
            code: "10.2.4",
            title: "Provide Certified-Robustness Proofs for Critical Classes",
            description:
          ...
          },
          {
            id: "v10.2.5",
            code: "10.2.5",
            title: "Use Adaptive Attacks in Regression Tests to Confirm Robustness",
            description:
      ...
      },
      {
        id: "v10.3",
        code: "C10.3",
        name: "Membership-Inference Mitigation",
        requirements: [
          {
            id: "v10.3.1",
            code: "10.3.1",
            title: "Use Regularization or Scaling to Reduce Overconfident Predictions",
            description:
          ...
          },
          {
            id: "v10.3.2",
            code: "10.3.2",
            title: "Employ Differentially-Private Optimization for Sensitive Datasets",
            description:
          ...
          },
          {
            id: "v10.3.3",
            code: "10.3.3",
            title: "Ensure Attack Simulations Show Low Attack AUC",
            description:
      ...
      },
      {
        id: "v10.4",
        code: "C10.4",
        name: "Model-Inversion Resistance",
        requirements: [
          {
            id: "v10.4.1",
            code: "10.4.1",
            title: "Avoid Direct Output of Sensitive Attributes",
            description:
          ...
          },
          {
            id: "v10.4.2",
            code: "10.4.2",
            title: "Throttle Repeated Adaptive Queries with Rate Limits",
            description:
          ...
          },
          {
            id: "v10.4.3",
            code: "10.4.3",
            title: "Train the Model with Privacy-Preserving Noise",
            description: "Verify that the model is trained with privacy-preserving noise.",
            level: 2,
            category: "v10",
            role: "D",
            references: [
      ...
      },
      {
        id: "v10.5",
        code: "C10.5",
        name: "Model-Extraction Defense",
        requirements: [
          {
            id: "v10.5.1",
            code: "10.5.1",
            title: "Enforce Rate Limits Tuned to Memorization Threshold",
            description:
          ...
          },
          {
            id: "v10.5.2",
            code: "10.5.2",
            title: "Use Automated Detectors for Query Entropy and Input Plurality",
            description:
          ...
          },
          {
            id: "v10.5.3",
            code: "10.5.3",
            title: "Ensure Provable Watermarks Against Suspected Clones",
            description:
          ...
          },
          {
            id: "v10.5.4",
            code: "10.5.4",
            title: "Securely Store and Rotate Watermark Keys",
            description:
          ...
          },
          {
            id: "v10.5.5",
            code: "10.5.5",
            title: "Integrate Extraction-Alert Events with Incident Response",
            description:
      ...
      },
      {
        id: "v10.6",
        code: "C10.6",
        name: "Inference-Time Poisoned-Data Detection",
        requirements: [
          {
            id: "v10.6.1",
            code: "10.6.1",
            title: "Use Anomaly Detectors for Inputs Before Inference",
            description:
          ...
          },
          {
            id: "v10.6.2",
            code: "10.6.2",
            title: "Tune Detector Thresholds to Minimize False Positives",
            description:
          ...
          },
          {
            id: "v10.6.3",
            code: "10.6.3",
            title: "Trigger Soft-Blocking and Human Review for Poisoned Inputs",
            description:
          ...
          },
          {
            id: "v10.6.4",
            code: "10.6.4",
            title: "Stress-Test Detectors with Adaptive, Triggerless Backdoor Attacks",
            description:
          ...
          },
          {
            id: "v10.6.5",
            code: "10.6.5",
            title: "Log and Re-evaluate Detection Efficacy Metrics",
            description:
      ...
      },
      {
        id: "v10.7",
        code: "C10.7",
        name: "Dynamic Security Policy Adaptation",
        requirements: [
          {
            id: "v10.7.1",
            code: "10.7.1",
            title: "Enable Dynamic Policy Updates without Restart",
            description:
          ...
          },
          {
            id: "v10.7.2",
            code: "10.7.2",
            title: "Cryptographically Sign and Validate Policy Updates",
            description:
          ...
          },
          {
            id: "v10.7.3",
            code: "10.7.3",
            title: "Log Dynamic Policy Changes with Full Audit Trails",
            description:
          ...
          },
          {
            id: "v10.7.4",
            code: "10.7.4",
            title: "Adapt Threat Detection Sensitivity Based on Risk Context",
            description:
          ...
          },
          {
            id: "v10.7.5",
            code: "10.7.5",
            title: "Ensure Explainability of Policy Adaptation Decisions",
            description:
      ...
      },
      {
        id: "v10.8",
        code: "C10.8",
        name: "Reflection-Based Security Analysis",
        requirements: [
          {
            id: "v10.8.1",
            code: "10.8.1",
            title: "Include Security-Focused Self-Assessment in Agent Reflection",
            description:
          ...
          },
          {
            id: "v10.8.2",
            code: "10.8.2",
            title: "Validate Reflection Outputs to Prevent Manipulation",
            description:
          ...
          },
          {
            id: "v10.8.3",
            code: "10.8.3",
            title: "Use Meta-Cognitive Analysis to Identify Security Risks",
            description:
          ...
          },
          {
            id: "v10.8.4",
            code: "10.8.4",
            title: "Trigger Enhanced Monitoring from Security Warnings",
            description:
          ...
          },
          {
            id: "v10.8.5",
            code: "10.8.5",
            title: "Continuously Learn from Security Reflections",
            description:
      ...
      },
      {
        id: "v10.9",
        code: "C10.9",
        name: "Evolution & Self-Improvement Security",
        requirements: [
          {
            id: "v10.9.1",
            code: "10.9.1",
            title: "Restrict Self-Modification to Safe Areas",
            description:
          ...
          },
          {
            id: "v10.9.2",
            code: "10.9.2",
            title: "Assess Security Impact of Evolution Proposals",
            description:
          ...
          },
          {
            id: "v10.9.3",
            code: "10.9.3",
            title: "Include Rollback Capabilities in Self-Improvement",
            description:
          ...
          },
          {
            id: "v10.9.4",
            code: "10.9.4",
            title: "Prevent Adversarial Manipulation of Improvement Algorithms",
            description:
          ...
          },
          {
            id: "v10.9.5",
            code: "10.9.5",
            title: "Bound Recursive Self-Improvement with Formal Safety Constraints",
            description:
    ...
    references: [
      ...
      {
        title: "Adversarial Training: A Survey — Zhao et al., 2024",
      ...
      {
        title: "Membership-Inference & Model-Inversion Risk Survey, 2025",
        url: "https://www.sciencedirect.com/science/article/abs/pii/S0950705125003867",
      },
      {
        title: "PURIFIER: Confidence-Score Defense against MI Attacks — AAAI 2023",
        url: "https://ojs.aaai.org/index.php/AAAI/article/view/26289",
      },
      {
        title: "Model-Inversion Attacks & Defenses Survey — AI Review, 2025",
        url: "https://link.springer.com/article/10.1007/s10462-025-11248-0",
      },
      {
        title: "Comprehensive Defense Framework Against Model Extraction — IEEE TDSC 2024",
        url: "https://doi.org/10.1109/TDSC.2023.3261327",
      },
      {
        title: "Fragile Model Watermarking Survey — 2025",
        url: "https://www.sciencedirect.com/science/article/abs/pii/S0165168425002026",
      },
      {
        title: "Data Poisoning in Deep Learning: A Survey — Zhao et al., 2025",
        url: "https://arxiv.org/abs/2503.22759",
      },
      {
        title: "BDetCLIP: Multimodal Prompting Backdoor Detection — Niu et al., 2024",
  ...
  v11: {
    ...
    subCategories: [
      {
        id: "v11.1",
        code: "C11.1",
        name: "Anonymization & Data Minimization",
        requirements: [
          {
            id: "v11.1.1",
            code: "11.1.1",
            title: "Remove or Hash Direct and Quasi-Identifiers",
            description: "Verify that direct and quasi-identifiers are removed, hashed.",
            level: 1,
            category: "v11",
            role: "D/V",
            references: [
          ...
          },
          {
            id: "v11.1.2",
            code: "11.1.2",
            title: "Automate Audits for K-Anonymity/L-Diversity",
            description:
          ...
          },
          {
            id: "v11.1.3",
            code: "11.1.3",
            title: "Prove No Identifier Leakage via Feature Importance Reports",
            description:
          ...
          },
          {
            id: "v11.1.4",
            code: "11.1.4",
            title: "Formally Prove or Certify Low Re-Identification Risk",
            description:
      ...
      },
      {
        id: "v11.2",
        code: "C11.2",
        name: "Right-to-be-Forgotten & Deletion Enforcement",
        requirements: [
          {
            id: "v11.2.1",
            code: "11.2.1",
            title: "Propagate Deletion Requests Across All Systems",
            description:
          ...
          },
          {
            id: "v11.2.2",
            code: "11.2.2",
            title: "Use Certified Machine-Unlearning Routines",
            description:
          ...
          },
          {
            id: "v11.2.3",
            code: "11.2.3",
            title: "Prove Minimal Influence of Forgotten Records Post-Unlearning",
            description:
          ...
          },
          {
            id: "v11.2.4",
            code: "11.2.4",
            title: "Immutably Log Deletion Events for Audits",
            description:
      ...
      },
      {
        id: "v11.3",
        code: "C11.3",
        name: "Differential-Privacy Safeguards",
        requirements: [
          {
            id: "v11.3.1",
            code: "11.3.1",
            title: "Monitor Cumulative Privacy Loss",
            description:
          ...
          },
          {
            id: "v11.3.2",
            code: "11.3.2",
            title: "Conduct Black-Box Privacy Audits to Estimate ε",
            description:
          ...
          },
          {
            id: "v11.3.3",
            code: "11.3.3",
            title: "Provide Formal Proofs for Post-Training Modifications",
            description:
      ...
      },
      {
        id: "v11.4",
        code: "C11.4",
        name: "Purpose-Limitation & Scope-Creep Protection",
        requirements: [
          {
            id: "v11.4.1",
            code: "11.4.1",
            title: "Tag Datasets and Models with Machine-Readable Purpose",
            description:
          ...
          },
          {
            id: "v11.4.2",
            code: "11.4.2",
            title: "Monitor Queries for Inconsistent Purpose",
            description:
          ...
          },
          {
            id: "v11.4.3",
            code: "11.4.3",
            title: "Block Redeployment without DPIA Review via Policy-as-Code",
            description:
          ...
          },
          {
            id: "v11.4.4",
            code: "11.4.4",
            title: "Demonstrate Traceability to Consented Scope",
            description:
      ...
      },
      {
        id: "v11.5",
        code: "C11.5",
        name: "Consent Management & Lawful-Basis Tracking",
        requirements: [
          {
            id: "v11.5.1",
            code: "11.5.1",
            title: "Use a Consent-Management Platform (CMP)",
            description:
          ...
          },
          {
            id: "v11.5.2",
            code: "11.5.2",
            title: "Validate Consent Token Scope Before Inference",
            description:
          ...
          },
          {
            id: "v11.5.3",
            code: "11.5.3",
            title: "Halt Processing on Denied or Withdrawn Consent",
            description:
      ...
      },
      {
        id: "v11.6",
        code: "C11.6",
        name: "Federated Learning with Privacy Controls",
        requirements: [
          {
            id: "v11.6.1",
            code: "11.6.1",
            title: "Employ Local Differential Privacy for Client Updates",
            description:
          ...
          },
          {
            id: "v11.6.2",
            code: "11.6.2",
            title: "Ensure Training Metrics are Differentially Private",
            description:
          ...
          },
          {
            id: "v11.6.3",
            code: "11.6.3",
            title: "Enable Poisoning-Resistant Aggregation",
            description:
          ...
          },
          {
            id: "v11.6.4",
            code: "11.6.4",
            title: "Formally Prove Overall ε Budget with Minimal Utility Loss",
            description:
    ...
    references: [
      {
        title: "GDPR & AI Compliance Best Practices",
        url: "https://www.exabeam.com/explainers/gdpr-compliance/the-intersection-of-gdpr-and-ai-and-6-compliance-best-practices/",
      },
      {
        title: "EU Parliament Study on GDPR & AI, 2020",
        url: "https://www.europarl.europa.eu/RegData/etudes/STUD/2020/641530/EPRS_STU%282020%29641530_EN.pdf",
      },
      {
        title: "ISO 31700-1:2023 — Privacy by Design for Consumer Products",
        url: "https://www.iso.org/standard/84977.html",
      },
      {
        title: "NIST Privacy Framework 1.1 (2025 Draft)",
        url: "https://www.nist.gov/privacy-framework",
      },
      {
        title: "Machine Unlearning: Right-to-Be-Forgotten Techniques",
        url: "https://www.kaggle.com/code/tamlhp/machine-unlearning-the-right-to-be-forgotten",
      },
      ...
      {
        title: "DP-SGD Explained — PyTorch Blog",
        url: "https://medium.com/pytorch/differential-privacy-series-part-1-dp-sgd-algorithm-explained-12512c3959a3",
      },
      {
        title: "Purpose-Limitation for AI — IJLIT 2025",
        url: "https://academic.oup.com/ijlit/article/doi/10.1093/ijlit/eaaf003/8121663",
      },
      {
        title: "Data-Protection Considerations for AI — URM Consulting",
        url: "https://www.urmconsulting.com/blog/data-protection-considerations-for-artificial-intelligence-ai",
      },
      {
        title: "Top Consent-Management Platforms, 2025",
        url: "https://www.enzuzo.com/blog/best-consent-management-platforms",
      },
      {
        title: "Secure Aggregation in DP Federated Learning — ArXiv 2024",
        url: "https://arxiv.org/abs/2407.19286",
      },
    ],
  },
  v12: {
    ...
    subCategories: [
        ...
        requirements: [
          {
            id: "v12.1.1",
            code: "12.1.1",
            title: "Log All User Prompts and Model Responses with Metadata",
            description:
            ...
            role: "D/V",
            references: [
              { title: "NIST SP 800-63B", url: "https://pages.nist.gov/800-63-4/sp800-63b.html" },
              { title: "ISO/IEC 27001:2022 A.8.5", url: "https://www.iso.org/standard/27001" },
            ],
          },
          {
            id: "v12.1.2",
            code: "12.1.2",
            title: "Securely Store Logs with Access Controls and Retention Policies",
            description:
          ...
          },
          {
            id: "v12.1.3",
            code: "12.1.3",
            title: "Encrypt Log Storage Systems",
            description:
          ...
          },
          {
            id: "v12.1.4",
            code: "12.1.4",
            title: "Automatically Redact or Mask Sensitive Data in Logs",
            description:
          ...
          },
          {
            id: "v12.1.5",
            code: "12.1.5",
            title: "Log Policy Decisions and Safety Filtering Actions",
            description:
      ...
      },
      {
        id: "v12.2",
        code: "C12.2",
        name: "Abuse Detection and Alerting",
        requirements: [
          {
            id: "v12.2.1",
            code: "12.2.1",
            title: "Detect and Alert on Known Attack Patterns",
            description:
          ...
          },
          {
            id: "v12.2.2",
            code: "12.2.2",
            title: "Integrate with SIEM Platforms",
            description:
          ...
          },
          {
            id: "v12.2.3",
            code: "12.2.3",
            title: "Enrich Security Events with AI-Specific Context",
            description:
          ...
          },
          {
            id: "v12.2.4",
            code: "12.2.4",
            title: "Use Behavioral Anomaly Detection to Identify Unusual Patterns",
            description:
          ...
          },
          {
            id: "v12.2.5",
            code: "12.2.5",
            title: "Implement Real-Time Alerting for Potential Violations",
            description:
          ...
          },
          {
            id: "v12.2.6",
            code: "12.2.6",
            title: "Include Custom Rules for AI-Specific Threat Patterns",
            description:
          ...
          },
          {
            id: "v12.2.7",
            code: "12.2.7",
            title: "Automate Incident Response Workflows",
            description:
        ...
        requirements: [
          {
            id: "v12.3.1",
            code: "12.3.1",
            title: "Track Basic Performance Metrics",
            description:
          ...
          },
          {
            id: "v12.3.2",
            code: "12.3.2",
            title: "Trigger Automated Alerts on Performance Degradation",
            description:
      ...
      },
      {
        id: "v12.4",
        code: "C12.4",
        name: "Performance & Behavior Telemetry",
        requirements: [
          {
            id: "v12.4.1",
            code: "12.4.1",
            title: "Continuously Collect and Monitor Operational Metrics",
            description:
          ...
          },
          {
            id: "v12.4.2",
            code: "12.4.2",
            title: "Track Success and Failure Rates with Error Categorization",
            description:
          ...
          },
          {
            id: "v12.4.3",
            code: "12.4.3",
            title: "Monitor Resource Utilization with Alerting",
            description:
      ...
      },
      {
        id: "v12.5",
        code: "C12.5",
        name: "AI Incident Response Planning & Execution",
        requirements: [
          {
            id: "v12.5.1",
            code: "12.5.1",
            title: "Address AI-Related Events in Incident Response Plans",
            description:
          ...
          },
          {
            id: "v12.5.2",
            code: "12.5.2",
            title: "Provide AI-Specific Forensic Tools and Expertise",
            description:
          ...
          },
          {
            id: "v12.5.3",
            code: "12.5.3",
            title: "Include AI-Specific Considerations in Post-Incident Analysis",
            description:
      ...
      },
      {
        id: "v12.6",
        code: "C12.6",
        name: "AI Performance Degradation Detection",
        requirements: [
          {
            id: "v12.6.1",
            code: "12.6.1",
            title: "Continuously Monitor Model Performance Scores",
            description:
          ...
          },
          {
            id: "v12.6.4",
            code: "12.6.4",
            title: "Automate Retraining or Replacement on Degradation",
            description:
          ...
          },
          {
            id: "v12.6.5",
            code: "12.6.5",
            title: "Analyze Root Causes of Degradation",
            description:
      ...
      },
      {
        id: "v12.7",
        code: "C12.7",
        name: "DAG Visualization & Workflow Security",
        requirements: [
          {
            id: "v12.7.1",
            code: "12.7.1",
            title: "Sanitize DAG Visualization Data",
            description:
          ...
          },
          {
            id: "v12.7.2",
            code: "12.7.2",
            title: "Implement Access Controls for Workflow Visualization",
            description:
          ...
          },
          {
            id: "v12.7.3",
            code: "12.7.3",
            title: "Protect DAG Data Integrity",
            description:
          ...
          },
          {
            id: "v12.7.4",
            code: "12.7.4",
            title: "Prevent Injection Attacks in Workflow Visualization",
            description:
          ...
          },
          {
            id: "v12.7.5",
            code: "12.7.5",
            title: "Rate-Limit and Validate Real-time DAG Updates",
            description:
      ...
      },
      {
        id: "v12.8",
        code: "C12.8",
        name: "Proactive Security Behavior Monitoring",
        requirements: [
          {
            id: "v12.8.1",
            code: "12.8.1",
            title: "Security-Validate Proactive Agent Behaviors",
            description:
          ...
          },
          {
            id: "v12.8.2",
            code: "12.8.2",
            title: "Evaluate Security Context for Autonomous Initiative",
            description:
          ...
          },
          {
            id: "v12.8.3",
            code: "12.8.3",
            title: "Analyze Proactive Behavior Patterns for Security Implications",
            description:
          ...
          },
          {
            id: "v12.8.4",
            code: "12.8.4",
            title: "Require Approval for Security-Critical Proactive Actions",
            description:
          ...
          },
          {
            id: "v12.8.5",
            code: "12.8.5",
            title: "Detect Deviations in Proactive Agent Patterns",
            description:
    ...
    references: [
      {
        title: "NIST AI RMF 1.0 - Manage 4.1 and 4.3",
        url: "https://nvlpubs.nist.gov/nistpubs/ai/nist.ai.100-1.pdf",
      },
      {
        title: "ISO/IEC 42001:2023 — AI Management Systems - Annex B 6.2.6",
        url: "https://www.iso.org/standard/81230.html",
      },
      {
        title: "EU AI Act — Article 12, 13, 16 and 19 on Logging",
  ...
  v13: {
    ...
    subCategories: [
      {
        id: "v13.1",
        code: "C13.1",
        name: "Kill-Switch & Override Mechanisms",
        requirements: [
          {
            id: "v13.1.1",
            code: "13.1.1",
            title: "Provide a Manual Kill-Switch",
            description:
          ...
          },
          {
            id: "v13.1.2",
            code: "13.1.2",
            title: "Restrict Access to Override Controls",
            description:
          ...
          },
          {
            id: "v13.1.4",
            code: "13.1.4",
            title: "Regularly Test Override Mechanisms",
            description: "Verify that override mechanisms are tested regularly.",
            level: 3,
            category: "v13",
            role: "V",
            references: [
      ...
      },
      {
        id: "v13.2",
        code: "C13.2",
        name: "Human-in-the-Loop Decision Checkpoints",
        requirements: [
          {
            id: "v13.2.1",
            code: "13.2.1",
            title: "Require Human Approval for High-Risk Decisions",
            description:
          ...
          },
          {
            id: "v13.2.2",
            code: "13.2.2",
            title: "Automatically Trigger Human Review Workflows",
            description:
          ...
          },
          {
            id: "v13.2.3",
            code: "13.2.3",
            title: "Define Fallback Procedures for Time-Sensitive Decisions",
            description:
      ...
      },
      {
        id: "v13.3",
        code: "C13.3",
        name: "Chain of Responsibility & Auditability",
        requirements: [
          {
            id: "v13.3.1",
            code: "13.3.1",
            title: "Log All Decisions and Interventions",
            description:
          ...
          },
          {
            id: "v13.3.2",
            code: "13.3.2",
            title: "Ensure Audit Logs are Tamper-Proof",
            description:
      ...
      },
      {
        id: "v13.4",
        code: "C13.4",
        name: "Explainable-AI Techniques",
        requirements: [
          {
            id: "v13.4.1",
            code: "13.4.1",
            title: "Provide Basic Explanations for Decisions",
            description:
          ...
          },
          {
            id: "v13.4.2",
            code: "13.4.2",
            title: "Validate Explanation Quality",
            description:
          ...
          },
          {
            id: "v13.4.3",
            code: "13.4.3",
            title: "Make Feature Importance Scores Available",
            description:
          ...
          },
          {
            id: "v13.4.4",
            code: "13.4.4",
            title: "Provide Counterfactual Explanations",
            description:
      ...
      },
      {
        id: "v13.5",
        code: "C13.5",
        name: "Model Cards & Usage Disclosures",
        requirements: [
          {
            id: "v13.5.1",
            code: "13.5.1",
            title: "Document Intended Use Cases and Limitations",
            description:
          ...
          },
          {
            id: "v13.5.2",
            code: "13.5.2",
            title: "Disclose Performance Metrics",
            description:
          ...
          },
          {
            id: "v13.5.3",
            code: "13.5.3",
            title: "Document Ethical Considerations and Biases",
            description:
          ...
          },
          {
            id: "v13.5.4",
            code: "13.5.4",
            title: "Version-Control Model Cards",
            description:
        ...
        requirements: [
          {
            id: "v13.6.1",
            code: "13.6.1",
            title: "Provide Confidence Scores or Uncertainty Measures",
            description:
          ...
          },
          {
            id: "v13.6.2",
            code: "13.6.2",
            title: "Trigger Actions Based on Uncertainty Thresholds",
            description:
          ...
          },
          {
            id: "v13.6.3",
            code: "13.6.3",
            title: "Calibrate and Validate Uncertainty Methods",
            description:
          ...
          },
          {
            id: "v13.6.4",
            code: "13.6.4",
            title: "Maintain Uncertainty Propagation",
            description:
      ...
      },
      {
        id: "v13.7",
        code: "C13.7",
        name: "User-Facing Transparency Reports",
        requirements: [
          {
            id: "v13.7.1",
            code: "13.7.1",
            title: "Clearly Communicate Data Usage Policies",
            description:
          ...
          },
          {
            id: "v13.7.2",
            code: "13.7.2",
            title: "Conduct and Report AI Impact Assessments",
            description:
          ...
          },
          {
            id: "v13.7.3",
            code: "13.7.3",
            title: "Publish Regular Transparency Reports",
            description:
    ...
    references: [
      ...
      {
        title: "ISO/IEC 42001:2023 — AI Management Systems Requirements",
        url: "https://www.iso.org/standard/81230.html",
      },
      {
      ...
      {
        title: "Model Cards for Model Reporting (Mitchell et al., 2018)",
      ...
      {
        title: "ISO/IEC 24029-2:2023 — Robustness of NN — Formal Methods",
        url: "https://www.iso.org/standard/79804.html",
      },
      {
        title: "IEEE 7001-2021 — Transparency of Autonomous Systems",
        url: "https://standards.ieee.org/ieee/7001/6929/",
      },
      {
        title: 'GDPR — Article 5 "Transparency Principle"',
        url: "https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX%3A32016R0679",
      },
      {
        title: "Human Oversight under Article 14 of the EU AI Act (Fink, 2025)",
        url: "https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5147196",
      },
    ],
  },
};
