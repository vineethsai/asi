          ...
          <div className="flex-1">
            <div className="flex justify-between items-center">
              ...
              <Link
                ...
                className="text-muted-foreground hover:text-foreground p-1.5 hover:bg-background/80 rounded-md"
              >
              ...
              <div className="mt-4">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {node.threatCategories.map((threat, i) => (
                    <span
                      key={i}
                      className="text-sm bg-threat/10 text-threat px-3 py-1 rounded-full font-medium"
                    >
                      {threat}
                    </span>
                  ))}
