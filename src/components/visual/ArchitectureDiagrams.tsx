  ...
  const renderHierarchicalDiagram = () => (
    <svg viewBox="0 0 600 300" className={className} xmlns="http://www.w3.org/2000/svg">
      ...
      <line
        ...
        stroke="#22c55e"
        strokeWidth="2"
        markerEnd="url(#hierarchicalArrow)"
      />
      <line
        x1="290"
        y1="120"
